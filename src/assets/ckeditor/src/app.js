...
import {AutoImage, Image, ImageCaption, ImageStyle, ImageToolbar} from '@ckeditor/ckeditor5-image';
...
window.Ckeditor = {
  ...
  create: async function(element, config) {
    ...
    const editor = await this.ClassicEditor.create(element, Object.assign({
      plugins: [
        Alignment,
        AutoImage,
        AutoLink,
