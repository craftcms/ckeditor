...
return [
    ...
    'By default, Craft’s CKEditor uses [List plugin]({listPluginUrl}) that supports [Todo Lists]({todoListPluginUrl}), but those lists cannot have custom styles. You can switch to using stylable lists ([DocumentList]({documentListPluginUrl})), but you won’t be able to use Todo Lists with them.' => 'By default, Craft’s CKEditor uses [List plugin]({listPluginUrl}) that supports [Todo Lists]({todoListPluginUrl}), but those lists cannot have custom styles. You can switch to using stylable lists ([DocumentList]({documentListPluginUrl})), but you won’t be able to use Todo Lists with them.',
