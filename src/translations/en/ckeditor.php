...
return [
    ...
    'By default, Craft’s CKEditor uses basic [List plugin]({listPluginUrl}). You can switch to using [DocumentList plugin]({documentListPluginUrl}) which supports styling of list elements as well as other, advanced features, but it doesn’t support [Todo Lists]({todoListPluginUrl}).',
