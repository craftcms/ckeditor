import { ImageInsertUI, ButtonView, IconImage, Command, Plugin, ImageUtils, Collection, ViewModel, createDropdown, DropdownButtonView, IconObjectSizeMedium, addListToDropdown, Widget, viewToModelPositionOutsideModelElement, toWidget, DomEventObserver, View, IconPlus, WidgetToolbarRepository, isWidget, findAttributeRange, LinkUI, ContextualBalloon, Range, SwitchButtonView, LabeledFieldView, createLabeledInputText, ClassicEditor, SourceEditing, Heading } from "ckeditor5";
/**
...
class CraftEntryTypesButtonView extends View {
  constructor(locale, options = {}) {
    ...
    this.entriesUi._getEntryTypeButtonsCollection(options.entryTypeOptions ?? []).forEach((item, index) => {
      let button = new ButtonView();
      if (item.model.expanded) {
        let btnConfig = {
          commandValue: item.model.commandValue,
          //entry type id
...
class CraftEntriesUI extends Plugin {
  ...
  _createToolbarEntriesButtons() {
    ...
    this.editor.ui.componentFactory.add(
      "createEntry",
      (locale) => new CraftEntryTypesButtonView(locale, {
        entriesUi: this,
        entryTypeOptions
      })
    );
    ...
    options.map((option) => {
      const definition = {
        ...
        model: new ViewModel({
          ...
          withText: option.expanded ? option.withText : true
 ...
 * @license GPL-3.0-or-later
 */
class CraftLinkEditing extends Plugin {
  static get pluginName() {
...
class CraftLinkElementView extends View {
  constructor(locale, options = {}) {
    super(locale);
    this.bindTemplate;
    this.set("isFocused", false);
    ...
    this.button = null;
    if (elementRefHandle) {
      const itemModel = this.linkUi.linkTypeDropdownItemModels[elementRefHandle];
      if (this.linkUi.linkTypeDropdownView.buttonView.label == itemModel.label) {
  ...
  render() {
    ...
    this.element.addEventListener("click", function(ev) {
      if (this.children[0].classList.contains("add") || ev.target.classList.contains("ck-button__label")) {
        _linkUI._hideUI();
    ...
    if (this.element.children.length == 0) {
      Craft.sendActionRequest("POST", "app/render-elements", {
        ...
        throw ((_d = (_c = e == null ? void 0 : e.response) == null ? void 0 : _c.data) == null ? void 0 : _d.message) ?? e;
      });
    }
  }
}
class CraftLinkAdvancedView extends View {
  constructor(locale, options = {}) {
    super(locale);
...
class CraftLinkUI extends Plugin {
  ...
  init() {
    ...
    this.conversionData = this.advancedLinkFields.map((field) => field.conversion ?? null).filter((field) => field);
  ...
  _getLinkElementRefHandle() {
    ...
    if (match) {
      ...
      if (elementRefHandle && typeof this.linkTypeDropdownItemModels[elementRefHandle] === "undefined") {
  ...
  _selectLinkTypeDropdownItem(elementRefHandle) {
    ...
    const label = elementRefHandle ? Craft.t("app", "{name}", { name: itemModel.label }) : itemModel.label;
    ...
    for (const advancedField of this.advancedLinkFields) {
      ...
      if (attributeModel && typeof formView[attributeModel] === "undefined") {
        if (advancedField.conversion.type === "bool") {
          ...
          formView[attributeModel].bind("isOn").to(linkCommand, attributeModel, (commandValue) => {
            if (commandValue === void 0) {
              formView[attributeModel].element.value = "";
              return false;
            } else {
              formView[attributeModel].element.value = advancedField.conversion.value;
              return true;
            }
          });
...
class CraftLink extends Plugin {
  static get requires() {
  ...
  (function(module, exports) {
    !function(e, t) {
      ...
      return function(e) {
        ...
        }, u = { INIT: "@@redux/INIT" + c(), REPLACE: "@@redux/REPLACE" + c() };
        function p(e2) {
