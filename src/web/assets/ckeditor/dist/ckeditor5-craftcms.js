import { ImageInsertUI as Wc, ButtonView as xa, icons as Jl, Command as Ss, Plugin as Bn, ImageUtils as ec, Collection as Cs, ViewModel as _a, createDropdown as Ts, DropdownButtonView as Hc, addListToDropdown as Os, Widget as Vc, viewToModelPositionOutsideModelElement as $c, toWidget as Yc, DomEventObserver as qc, WidgetToolbarRepository as Gl, isWidget as Kc, findAttributeRange as Qc, View as $o, LinkUI as Xl, ContextualBalloon as Gc, Range as Xc, LabeledFieldView as Zc, createLabeledInputText as Jc, ClassicEditor as eu, SourceEditing as tc, Heading as tu } from "ckeditor5";
/**
...
class Su extends Wc {
  ...
  init() {
    ...
    const I = this.editor.ui.componentFactory, b = (a) => this._createToolbarImageButton(a);
    I.add("insertImage", b), I.add("imageInsert", b);
  }
  get _assetSources() {
    return this.editor.config.get("assetSources");
  }
  _createToolbarImageButton(I) {
    const b = this.editor, a = b.t, u = new xa(I);
  ...
  _showImageSelectModal() {
    const I = this._assetSources, b = this.editor, a = b.config, u = Object.assign({}, a.get("assetSelectionCriteria"), {
      kind: "image"
    });
  ...
  _processAssetUrls(I, b) {
    return new Promise((a) => {
      if (!I.length) {
        a();
        return;
      }
      const u = this.editor, c = u.config.get("defaultTransform"), o = new Craft.Queue(), S = [];
      o.on("afterRun", () => {
        u.execute("insertImage", { source: S }), a();
      });
      for (const m of I)
        o.push(
          () => new Promise((g) => {
            ...
            if (!y && c)
              this._getTransformUrl(m.id, c, (v) => {
                S.push(v), g();
              });
            else {
  ...
  _buildAssetUrl(I, b, a) {
    return `${b}#asset:${I}:${a ? "transform:" + a : "url"}`;
  }
  _removeTransformFromUrl(I) {
    return I.replace(/(^|\/)(_[^\/]+\/)([^\/]+)$/, "$1$3");
  }
  _isTransformUrl(I) {
    return /(^|\/)_[^\/]+\/[^\/]+$/.test(I);
  }
  _getTransformUrl(I, b, a) {
    Craft.sendActionRequest("POST", "ckeditor/ckeditor/image-url", {
      ...
      a(this._buildAssetUrl(I, u.url, b));
    }).catch(() => {
      alert("There was an error generating the transform URL.");
    });
  }
  _getAssetUrlComponents(I) {
    const b = I.match(
...
class nu extends Ss {
  refresh() {
    const I = this._element(), b = this._srcInfo(I);
  ...
  _element() {
    const I = this.editor;
    return I.plugins.get("ImageUtils").getClosestSelectedImageElement(
      I.model.document.selection
    );
  }
  _srcInfo(I) {
    if (!I || !I.hasAttribute("src"))
      return null;
    const b = I.getAttribute("src"), a = b.match(
  ...
  execute(I) {
    ...
    if (this.value = {
      ...
      const o = `#asset:${c.assetId}` + (I.transform ? `:transform:${I.transform}` : "");
      a.change((S) => {
        const m = c.src.replace(/#.*/, "") + o;
        S.setAttribute("src", m, u);
      }), Craft.sendActionRequest("post", "ckeditor/ckeditor/image-url", {
        data: {
          assetId: c.assetId,
          transform: I.transform
        ...
        a.change((m) => {
          const g = S.url + o;
          m.setAttribute("src", g, u), S.width && m.setAttribute("width", S.width, u), S.height && m.setAttribute("height", S.height, u);
        });
      });
    }
  }
...
class nc extends Bn {
  ...
  constructor(I) {
    super(I), I.config.define("transforms", []);
  }
  init() {
    const I = this.editor, b = new nu(I);
    I.commands.add("transformImage", b);
  }
}
/**
 * @link https://craftcms.com/
...
class ou extends Bn {
  ...
  init() {
    const I = this.editor, b = I.config.get("transforms"), a = I.commands.get("transformImage");
   ...
   */
  _registerImageTransformDropdown(I) {
    const b = this.editor, a = b.t, u = {
      ...
      const m = b.commands.get("transformImage"), g = Ts(S, Hc), y = g.buttonView;
      return y.set({
      ...
      ), this.listenTo(g, "execute", (v) => {
        b.execute(v.source.commandName, {
   ...
   */
  _getOptionLabelValue(I) {
    return I.label || I.value || this.editor.t("Original");
  }
  /**
   ...
   */
  _getTransformDropdownListItemDefinitions(I, b) {
    const a = new Cs();
    return I.map((u) => {
      const c = {
        type: "button",
...
class rc extends Bn {
  ...
  init() {
    const I = this.editor, b = new au(I);
    I.commands.add("imageEditor", b);
  }
}
/**
 * @link https://craftcms.com/
...
class su extends Bn {
  ...
  _registerImageEditorButton() {
    const I = this.editor, b = I.t, a = I.commands.get("imageEditor"), u = () => {
      const c = new xa();
      return c.set({
        label: b("Edit Image"),
        withText: !0
      }), c.bind("isEnabled").to(a), this.listenTo(c, "execute", (o) => {
        I.execute("imageEditor"), I.editing.view.focus();
      }), c;
    };
    I.ui.componentFactory.add("imageEditor", u);
  }
}
/**
 * @link https://craftcms.com/
...
class cu extends Bn {
  ...
  init() {
    ...
    const I = this.editor;
    I.commands.add("insertEntry", new lu(I)), I.editing.mapper.on(
      "viewToModelPosition",
      $c(I.model, (b) => {
   ...
   */
  _defineConverters() {
    const I = this.editor.conversion;
    I.for("upcast").elementToElement({
      ...
      model: (a, { writer: u }) => {
        const c = a.getAttribute("data-card-html"), o = a.getAttribute("data-entry-id"), S = a.getAttribute("data-site-id") ?? null;
      ...
      view: (a, { writer: u }) => {
        const c = a.getAttribute("entryId") ?? null, o = a.getAttribute("siteId") ?? null, S = u.createContainerElement("div", {
          class: "cke-entry-card",
          "data-entry-id": c,
          "data-site-id": o
        });
        return b(a, u, S), Yc(S, u);
      }
    ...
    const b = (a, u, c) => {
      this._getCardHtml(a).then((o) => {
        ...
        u.insert(u.createPositionAt(c, 0), S);
        const m = this.editor;
   ...
   * @private
   */
  async _getCardHtml(I) {
    var S, m, g;
    let b = I.getAttribute("cardHtml") ?? null, a = $(this.editor.sourceElement).parents(".field");
...
class uu extends qc {
  constructor(I) {
    super(I), this.domEventType = "dblclick";
  }
  onDomEvent(I) {
    this.fire(I.type, I);
  }
...
class du extends Bn {
   ...
   */
  init() {
    this.editor.ui.componentFactory.add("createEntry", (I) => this._createToolbarEntriesButton(I)), this.editor.ui.componentFactory.add("editEntryBtn", (I) => this._createEditEntryBtn(I)), this._listenToEvents();
  }
  /**
   * @inheritDoc
   */
   ...
   */
  _listenToEvents() {
    const I = this.editor.editing.view, b = I.document;
    I.addObserver(uu), this.editor.listenTo(b, "dblclick", (a, u) => {
  ...
  _initEditEntrySlideout(I = null, b = null) {
   ...
   * @private
   */
  _getDropdownItemsDefinitions(I, b) {
    const a = new Cs();
    return I.map((u) => {
      const c = {
        type: "button",
   ...
   */
  _getCardElement(I) {
    return $(this.editor.ui.element).find('.element.card[data-id="' + I + '"]');
  }
  /**
   ...
   * @private
   */
  _showEditEntrySlideout(I, b, a) {
    const u = this.editor, c = this.getElementEditor();
    let o = this._getCardElement(I);
    const S = o.data("owner-id"), m = Craft.createElementEditor(this.elementType, null, {
      elementId: I,
      params: {
        siteId: b
      },
   ...
   * @private
   */
  async _showCreateEntrySlideout(I) {
    var m, g;
...
class pu extends Bn {
  ...
  _defineConverters() {
    ...
    for (let b = 0; b < this.conversionData.length; b++)
      I.for("downcast").attributeToElement({
      ...
      }), I.for("upcast").elementToAttribute({
        view: {
          name: "a",
          attributes: {
  ...
  _adjustLinkCommand() {
    const I = this.editor, b = I.commands.get("link");
    let a = !1;
    b.on(
      "execute",
      (u, c) => {
        ...
        u.stop(), a = !0;
        const o = c[c.length - 1], S = I.model.document.selection;
        I.model.change((m) => {
          I.execute("link", ...c);
          const g = S.getFirstPosition();
          this.conversionData.forEach((y) => {
            if (S.isCollapsed) {
              const v = g.textNode || g.nodeBefore;
              o[y.model] ? m.setAttribute(
                y.model,
                o[y.model],
                m.createRangeOn(v)
              ) : m.removeAttribute(y.model, m.createRangeOn(v)), m.removeSelectionAttribute(y.model);
            } else {
              const v = I.model.schema.getValidRanges(
                S.getRanges(),
                y.model
              );
              for (const C of v)
  ...
  _adjustUnlinkCommand() {
    const I = this.editor, b = I.commands.get("unlink"), { model: a } = I, { selection: u } = a.document;
    let c = !1;
    b.on(
      "execute",
      (o) => {
        c || (o.stop(), a.change(() => {
          c = !0, I.execute("unlink"), c = !1, a.change((S) => {
            let m;
...
class hu extends $o {
  constructor(I, b = {}) {
    super(I), this.editor = null, this._linkUI = null, this.linkUi = null, this.elementId = null, this.siteId = null, this.linkOption = null, this.button = null, this.bindTemplate, this.set("isFocused", !1), this.editor = b.editor, this.linkUi = b.linkUi, this.linkUi._linkUI, this.elementId = this.linkUi._getLinkElementId(), this.siteId = this.linkUi._getLinkSiteId(), this.linkOption = b.linkOption;
    const a = this.linkUi._getLinkElementType();
    if (this.button = null, a) {
      const u = this.linkUi.linkTypeDropdownItemModels[a];
      this.linkUi.linkTypeDropdownView.buttonView.label == u.label && (this.button = "loading...");
    }
  ...
  render() {
    super.render();
    const I = this.linkUi._linkUI, b = this.linkUi, a = this.linkOption;
    this.element.addEventListener("click", function(u) {
      u.target.classList.contains("ck-button__label") && (I._hideUI(), b._showElementSelectorModal(a));
      ...
      var c, o, S, m;
      throw Craft.cp.displayError((o = (c = u == null ? void 0 : u.response) == null ? void 0 : c.data) == null ? void 0 : o.message), ((m = (S = u == null ? void 0 : u.response) == null ? void 0 : S.data) == null ? void 0 : m.message) ?? u;
    });
  }
}
class mu extends $o {
  constructor(I, b = {}) {
    ...
    this.set("isFocused", !1), this.set("label", Craft.t("app", "Advanced")), this.editor = b.editor, this.linkUi = b.linkUi, this.advancedLinkFields = b.advancedLinkFields, this.children = this.createCollection(), this.advancedChildren = this.createCollection(), this.setTemplate({
      tag: "details",
      attributes: {
        class: [
          "ck",
          "ck-form__details",
          "link-type-advanced",
          a.if("isFocused", "ck-form__details--focused"),
          a.to("class")
        ]
      },
      children: this.children
    }), this.summary = new $o(I), this.summary.setTemplate({
      tag: "summary",
      attributes: {
        class: ["ck", "ck-form__details__summary"]
      },
      children: [{ text: a.to("label") }]
    }), this.children.add(this.summary), this.advancedFieldsContainer = new $o(I), this.advancedFieldsContainer.setTemplate({
      tag: "div",
      attributes: {
...
class gu extends Bn {
  ...
  constructor() {
    super(...arguments), this.linkTypeWrapperView = null, this.linkTypeDropdownView = null, this.linkTypeDropdownItemModels = [], this.elementTypeRefHandleRE = null, this.urlWithRefHandleRE = null, this.conversionData = [], this.editor.config.define("linkOptions", []), this.editor.config.define("advancedLinkFields", []);
  }
  init() {
    const I = this.editor;
    this._linkUI = I.plugins.get(Xl), this._balloon = I.plugins.get(Gc);
    const b = I.config.get("linkOptions"), a = I.config.get("advancedLinkFields");
  ...
  _modifyFormViewTemplate(I, b) {
    ...
    a.template.attributes.class.push(
      ...
      "ck-vertical-form"
    ), I && I.length && this._linkOptionsDropdown(I, a), b && b.length && this._advancedLinkFields(b, a);
  }
  _urlInputValue() {
    return this._linkUI.formView.urlInputView.fieldView.element.value;
  }
  _urlInputRefMatch(I) {
    return this._urlInputValue().match(I);
  }
  ////////////////////// Sites Dropdown //////////////////////
  ...
  _linkOptionsDropdown(I, b) {
    const { urlInputView: a } = b, { fieldView: u } = a;
    this.linkTypeDropdownView = Ts(b.locale), this.linkTypeDropdownView.buttonView.set({
      label: "",
      withText: !0,
      isVisible: !0
    }), this.linkTypeDropdownItemModels = Object.fromEntries(
      this._getLinkListItemDefinitions(I).map((c) => [
        c.handle,
        c
      ])
    ), Os(
      ...
      if (c.source.linkOption) {
        const o = c.source.linkOption;
        this._selectLinkTypeDropdownItem(o.refHandle), this._showLinkTypeForm(o, b);
      } else
        this._selectLinkTypeDropdownItem("default"), this._showLinkTypeForm("default", b);
    }), b._focusables.add(this.linkTypeDropdownView), b.focusTracker.add(this.linkTypeDropdownView.element), this.listenTo(u, "change:value", () => {
      this._toggleLinkTypeDropdownView();
      const c = this._getLinkElementType();
      c ? this._showLinkTypeForm(
        this.linkTypeDropdownItemModels[c].linkOption,
        b
      ) : this._showLinkTypeForm("default", b);
    }), this.listenTo(u, "input", () => {
      this._toggleLinkTypeDropdownView();
    });
  }
  _getLinkElementType() {
    ...
    return b && (I = b[2], I && typeof this.linkTypeDropdownItemModels[I] > "u" && (I = null)), I;
  }
  _getLinkElementId() {
    let I = null;
    const b = this._urlInputRefMatch(this.urlWithRefHandleRE);
    return b && (I = b[4] ? parseInt(b[4], 10) : null), I;
  }
  _getLinkSiteId() {
    let I = null;
    const b = this._urlInputRefMatch(this.urlWithRefHandleRE);
    return b && (I = b[5] ? parseInt(b[5], 10) : null), I;
  }
  _toggleLinkTypeDropdownView() {
    let I = this._getLinkElementType();
    I ? (this.linkTypeDropdownView.buttonView.set("isVisible", !0), this._selectLinkTypeDropdownItem(I)) : this._selectLinkTypeDropdownItem("default");
  }
  _selectLinkTypeDropdownItem(I) {
    const b = this.linkTypeDropdownItemModels[I], a = I ? Craft.t("app", "{name}", { name: b.label }) : b.label;
  ...
  _showLinkTypeForm(I, b) {
    let a = null;
    I === "default" ? (a = b.urlInputView, a.template.attributes.class.push("link-input", "flex-grow")) : (this._getLinkSiteId(), this._getLinkElementId(), a = new hu(b.locale, {
      editor: this.editor,
      linkUi: this,
      linkOption: I,
      value: this._urlInputValue()
    }));
    const { children: u } = b, { urlInputView: c } = b;
    this.linkTypeWrapperView !== null ? u.remove(this.linkTypeWrapperView) : u.remove(c), this.linkTypeWrapperView = new $o(), this.linkTypeWrapperView.setTemplate({
      tag: "div",
      children: [this.linkTypeDropdownView, a],
      attributes: {
        class: ["ck", "link-type-group", "flex", "flex-nowrap"]
      }
    }), u.add(this.linkTypeWrapperView, 0);
  }
  _showElementSelectorModal(I) {
    const b = this.editor, a = b.model, u = a.document.selection, c = u.isCollapsed, o = u.getFirstRange(), S = () => {
      b.editing.view.focus(), !c && o && a.change((m) => {
        m.setSelection(o);
      }), this._linkUI._hideFakeVisualSelection();
    };
    this._linkUI._getSelectedLinkElement() || this._linkUI._showFakeVisualSelection(), Craft.createElementSelectorModal(I.elementType, {
      ...
      onSelect: (m) => {
        if (m.length) {
          const g = m[0], y = `${g.url}#${I.refHandle}:${g.id}@${g.siteId}`;
          b.editing.view.focus(), !u.isCollapsed && o ? (a.change((C) => {
            C.setSelection(o);
          }), b.commands.get("link").execute(y)) : a.change((v) => {
            if (v.insertText(
              g.label,
              {
                linkHref: y
              ...
              try {
                const C = o.clone();
                C.end.path[1] += g.label.length, v.setSelection(C);
              } catch {
              }
  ...
  _advancedLinkFields(I, b) {
    this._addAdvancedLinkFieldInputs(I, b), this._handleAdvancedLinkFieldsFormSubmit(b), this._trackAdvancedLinkFieldsValueChange();
  }
  _addAdvancedLinkFieldInputs(I, b) {
    var o;
    const a = this.editor.commands.get("link"), { children: u } = b, c = new mu(b.locale, {
      editor: this.editor,
      linkUi: this,
      advancedLinkFields: I
    });
    for (const S of I) {
      let m = (o = S.conversion) == null ? void 0 : o.model;
      if (m && typeof b[m] > "u") {
        let g = this._createLabeledField(
          c,
          b,
          S.label,
          S.info
        );
        b[m] = g, b[m].fieldView.bind("value").to(a, m), b[m].fieldView.element.value = a[m] || "";
      } else if (S.value === "urlSuffix") {
        let g = this._createLabeledField(
          c,
          b,
          S.label,
        ...
        this.listenTo(
          ...
          (y, v, C, O) => {
            if (C !== O && !C) {
              let P = y.source.element.value;
              const G = this._urlInputRefMatch(this.urlWithRefHandleRE);
              if (G) {
                let K = new URL(G[1]), z = K.search, B = K.hash, N = G[1].replace(B, "").replace(z, "");
                const M = this._urlInputValue().replace(
                  G[1],
                  N + P
                );
                b.urlInputView.fieldView.set("value", M);
              }
            }
          }
        ), this.listenTo(b.urlInputView.fieldView, "change:value", () => {
          this._toggleUrlSuffixInputView(g);
        }), this.listenTo(b.urlInputView.fieldView, "input", () => {
          this._toggleUrlSuffixInputView(g);
        });
      } else if (S.value === "target") {
        let g = b._manualDecoratorSwitches._items.filter(
          (y) => y.name === "linkOpenInNewTab"
        );
        if (g.length) {
          g = g[0];
          const y = new $o();
          ...
          }), c.advancedChildren.add(y);
        }
      }
    }
    u.add(c, 1);
  }
  _createLabeledField(I, b, a, u) {
    let c = new Zc(
      b.locale,
      Jc
    );
    return c.label = a, u && (c.infoText = u), I.advancedChildren.add(c), c;
  }
  _toggleUrlSuffixInputView(I) {
    const b = this._urlInputRefMatch(this.urlWithRefHandleRE);
    if (b) {
      let a = new URL(b[1]), u = a.search, c = a.hash;
      I.fieldView.set("value", u + c);
    }
  }
  _handleAdvancedLinkFieldsFormSubmit(I) {
    ...
    I.on(
      ...
      () => {
        ...
        u.forEach((o) => {
          let S = [];
          S[o] = I[o].fieldView.element.value, Object.assign(c, S);
        }), a.once(
          "execute",
          (o, S) => {
            S.length < 3 ? S.push(c) : S.length === 3 && Object.assign(S[2], c);
          },
          { priority: "highest" }
        );
      },
  ...
  _trackAdvancedLinkFieldsValueChange() {
    const I = this.editor, b = I.commands.get("link"), a = I.model.document.selection;
    this.conversionData.forEach((u) => {
      b.set(u.model, null), I.model.document.on("change", () => {
  ...
  return Zl || (Zl = 1, function(Se, I) {
    (function(b, a) {
      ...
      return function(b) {
        ...
        return u.m = b, u.c = a, u.d = function(c, o, S) {
          u.o(c, o) || Object.defineProperty(c, o, { enumerable: !0, get: S });
        }, u.r = function(c) {
          ...
          if (u.r(S), Object.defineProperty(S, "default", { enumerable: !0, value: c }), 2 & o && typeof c != "string") for (var m in c) u.d(S, m, (function(g) {
            return c[g];
          }).bind(null, m));
          return S;
        }, u.n = function(c) {
        ...
        function o(y, v = !0) {
          ...
          const C = Object(c.stringify)(y, g, null, { maxDepth: 2 });
        ...
        function O(P) {
          return c(P) ? o(P) ? "attribute:" + P.name : v(P) ? "root:" + P.name : "container:" + P.name : P.data;
        }
        u.d(a, "d", function() {
          return c;
        }), u.d(a, "b", function() {
        ...
        (function(c, o) {
          var S = "[object Arguments]", m = "[object Map]", g = "[object Object]", y = "[object Set]", v = /^\[object .+?Constructor\]$/, C = /^(?:0|[1-9]\d*)$/, O = {};
          ...
          var P = typeof c == "object" && c && c.Object === Object && c, G = typeof self == "object" && self && self.Object === Object && self, K = P || G || Function("return this")(), z = a && !a.nodeType && a, B = z && typeof o == "object" && o && !o.nodeType && o, N = B && B.exports === z, M = N && P.process, W = function() {
            try {
          ...
          function oe(V, ae) {
            for (var ke = -1, Ce = V == null ? 0 : V.length; ++ke < Ce; ) if (ae(V[ke], ke, V)) return !0;
            return !1;
          }
          function Q(V) {
            var ae = -1, ke = Array(V.size);
          ...
          var A, se, le, te = Array.prototype, ce = Function.prototype, ye = Object.prototype, J = K["__core-js_shared__"], de = ce.toString, D = ye.hasOwnProperty, ie = (A = /[^.]+$/.exec(J && J.keys && J.keys.IE_PROTO || "")) ? "Symbol(src)_1." + A : "", be = ye.toString, Te = RegExp("^" + de.call(D).replace(/[\\^$.*+?()[\]{}|]/g, "\\$&").replace(/hasOwnProperty|(function).*?(?=\\\()| for .+?(?=\\\])/g, "$1.*?") + "$"), we = N ? K.Buffer : void 0, Ne = K.Symbol, xe = K.Uint8Array, ze = ye.propertyIsEnumerable, Je = te.splice, X = Ne ? Ne.toStringTag : void 0, Y = Object.getOwnPropertySymbols, me = we ? we.isBuffer : void 0, l = (se = Object.keys, le = Object, function(V) {
            return se(le(V));
          }), f = gn(K, "DataView"), w = gn(K, "Map"), U = gn(K, "Promise"), F = gn(K, "Set"), H = gn(K, "WeakMap"), he = gn(Object, "create"), je = bn(f), Re = bn(w), Xe = bn(U), Ve = bn(F), At = bn(H), kt = Ne ? Ne.prototype : void 0, Jt = kt ? kt.valueOf : void 0;
          function wt(V) {
            var ae = -1, ke = V == null ? 0 : V.length;
          ...
          function Er(V) {
            var ae = -1, ke = V == null ? 0 : V.length;
            for (this.__data__ = new cn(); ++ae < ke; ) this.add(V[ae]);
          }
          function Tt(V) {
          ...
          function pt(V, ae) {
            var ke = ar(V), Ce = !ke && ir(V), it = !ke && !Ce && Cn(V), qe = !ke && !Ce && !it && Gr(V), st = ke || Ce || it || qe, tt = st ? function(bt, Nt) {
          ...
          function Yn(V, ae) {
            for (var ke = V.length; ke--; ) if (Tr(V[ke][0], ae)) return ke;
            return -1;
          }
          function Sn(V) {
            return V == null ? V === void 0 ? "[object Undefined]" : "[object Null]" : X && X in Object(V) ? function(ae) {
            ...
            return V === ae || (V == null || ae == null || !On(V) && !On(ae) ? V != V && ae != ae : function(qe, st, tt, Ot, nt, bt) {
              ...
              if (yn && !Nn) return bt || (bt = new Tt()), Nt || Gr(qe) ? Yt(qe, st, tt, Ot, nt, bt) : function(rt, Ue, qn, Kt, Or, Mt, nn) {
                switch (qn) {
                  ...
                  case y:
                    var Qt = 1 & Kt;
                    if (Ht || (Ht = j), rt.size != Ue.size && !Qt) return !1;
                    var cr = nn.get(rt);
                    if (cr) return cr == Ue;
                    Kt |= 2, nn.set(rt, Ue);
          ...
          function wo(V) {
            return !(!lr(V) || function(ae) {
              return !!ie && ie in ae;
            }(V)) && (sr(V) ? Te : v).test(bn(V));
          }
          function en(V) {
            if (ke = (ae = V) && ae.constructor, Ce = typeof ke == "function" && ke.prototype || ye, ae !== Ce) return l(V);
            var ae, ke, Ce, it = [];
            for (var qe in Object(V)) D.call(V, qe) && qe != "constructor" && it.push(qe);
            return it;
          }
          function Yt(V, ae, ke, Ce, it, qe) {
            var st = 1 & ke, tt = V.length, Ot = ae.length;
            ...
            for (qe.set(V, ae), qe.set(ae, V); ++bt < tt; ) {
              ...
              if (Ce) var Nn = st ? Ce(Wt, ht, bt, ae, V, qe) : Ce(ht, Wt, bt, V, ae, qe);
              if (Nn !== void 0) {
                if (Nn) continue;
                Nt = !1;
                break;
              ...
              } else if (ht !== Wt && !it(ht, Wt, ke, Ce, qe)) {
                Nt = !1;
                break;
              }
            }
            return qe.delete(V), qe.delete(ae), Nt;
          }
          function xr(V) {
          ...
          wt.prototype.clear = function() {
            ...
            return this.size += this.has(V) ? 0 : 1, ke[V] = he && ae === void 0 ? "__lodash_hash_undefined__" : ae, this;
          }, gt.prototype.clear = function() {
            this.__data__ = [], this.size = 0;
          }, gt.prototype.delete = function(V) {
            var ae = this.__data__, ke = Yn(ae, V);
            ...
            return Yn(this.__data__, V) > -1;
          }, gt.prototype.set = function(V, ae) {
            var ke = this.__data__, Ce = Yn(ke, V);
            return Ce < 0 ? (++this.size, ke.push([V, ae])) : ke[Ce][1] = ae, this;
          }, cn.prototype.clear = function() {
            this.size = 0, this.__data__ = { hash: new wt(), map: new (w || gt)(), string: new wt() };
          }, cn.prototype.delete = function(V) {
            var ae = qt(this, V).delete(V);
            return this.size -= ae ? 1 : 0, ae;
          }, cn.prototype.get = function(V) {
            return qt(this, V).get(V);
          }, cn.prototype.has = function(V) {
            return qt(this, V).has(V);
          }, cn.prototype.set = function(V, ae) {
            var ke = qt(this, V), Ce = ke.size;
            return ke.set(V, ae), this.size += ke.size == Ce ? 0 : 1, this;
            ...
            var ae = this.__data__, ke = ae.delete(V);
            ...
            if (ke instanceof gt) {
              var Ce = ke.__data__;
              if (!w || Ce.length < 199) return Ce.push([V, ae]), this.size = ++ke.size, this;
              ke = this.__data__ = new cn(Ce);
            }
            return ke.set(V, ae), this.size = ke.size, this;
          };
          var Sr = Y ? function(V) {
            return V == null ? [] : (V = Object(V), function(ae, ke) {
          ...
          (f && ut(new f(new ArrayBuffer(1))) != "[object DataView]" || w && ut(new w()) != m || U && ut(U.resolve()) != "[object Promise]" || F && ut(new F()) != y || H && ut(new H()) != "[object WeakMap]") && (ut = function(V) {
            var ae = Sn(V), ke = ae == g ? V.constructor : void 0, Ce = ke ? bn(ke) : "";
            if (Ce) switch (Ce) {
              case je:
        ...
        var c, o = function() {
          ...
          return function(M) {
            if (N[M] === void 0) {
              var W = document.querySelector(M);
        ...
        function g(N) {
          for (var M = -1, W = 0; W < m.length; W++) if (m[W].identifier === N) {
            M = W;
            break;
          }
          return M;
        ...
        function y(N, M) {
          for (var W = {}, R = [], oe = 0; oe < N.length; oe++) {
            var Q = N[oe], j = M.base ? Q[0] + M.base : Q[0], A = W[j] || 0, se = "".concat(j, " ").concat(A);
            W[j] = A + 1;
        ...
        function v(N) {
          var M = document.createElement("style"), W = N.attributes || {};
          if (W.nonce === void 0) {
            var R = u.nc;
            R && (W.nonce = R);
          }
          if (Object.keys(W).forEach(function(Q) {
            M.setAttribute(Q, W[Q]);
        ...
        var C, O = (C = [], function(N, M) {
          return C[N] = M, C.filter(Boolean).join(`
`);
        });
        function P(N, M, W, R) {
          var oe = W ? "" : R.media ? "@media ".concat(R.media, " {").concat(R.css, "}") : R.css;
          if (N.styleSheet) N.styleSheet.cssText = O(M, oe);
          else {
            var Q = document.createTextNode(oe), j = N.childNodes;
            j[M] && N.removeChild(j[M]), j.length ? N.insertBefore(Q, j[M]) : N.appendChild(Q);
          }
        }
        function G(N, M, W) {
          var R = W.css, oe = W.media, Q = W.sourceMap;
...
/*# sourceMappingURL=data:application/json;base64,`.concat(btoa(unescape(encodeURIComponent(JSON.stringify(Q)))), " */")), N.styleSheet) N.styleSheet.cssText = R;
        ...
        function B(N, M) {
          ...
          if (M.singleton) {
            var Q = z++;
            W = K || (K = v(M)), R = P.bind(null, W, Q, !1), oe = P.bind(null, W, Q, !0);
          } else W = v(M), R = G.bind(null, W, M), oe = function() {
            (function(j) {
        ...
        b.exports = function(N, M) {
          ...
          return function(R) {
            if (R = R || [], Object.prototype.toString.call(R) === "[object Array]") {
              ...
              for (var j = y(R, M), A = 0; A < W.length; A++) {
                var se = g(W[A]);
            ...
            return this.map(function(S) {
              var m = function(g, y) {
                ...
                if (y && typeof btoa == "function") {
                  var O = (G = C, "/*# sourceMappingURL=data:application/json;charset=utf-8;base64," + btoa(unescape(encodeURIComponent(JSON.stringify(G)))) + " */"), P = C.sources.map(function(K) {
                    return "/*# sourceURL=" + C.sourceRoot + K + " */";
                  });
                  return [v].concat(P).concat([O]).join(`
`);
                }
                var G;
                return [v].join(`
`);
        ...
        function S(y) {
          ...
          if (typeof y[0] == "string") c.a.warn(`[CKEditorInspector] The CKEditorInspector.attach( '${y[0]}', editor ) syntax has been deprecated and will be removed in the near future. To pass a name of an editor instance, use CKEditorInspector.attach( { '${y[0]}': editor } ) instead. Learn more in https://github.com/ckeditor/ckeditor5-inspector/blob/master/README.md.`), v.editors[y[0]] = y[1];
            ...
            else for (const O in y[0]) v.editors[O] = y[0][O];
        ...
        function g(y, v) {
          ...
          for (let O = 0; O < C; O++) if (y[O] != v[O]) return O;
        ...
        function G(N, M) {
          const W = {};
          return Object.assign(W, { index: N.index, path: N.getPath(), node: N, positionsBefore: [], positionsAfter: [] }), Object(c.d)(N) ? function(R, oe) {
            const Q = R.node;
            ...
            for (const j of Q.getChildren()) R.children.push(G(j, oe));
            (function(j, A) {
              for (const se of A) {
                const le = K(j, se);
                for (const te of le) {
              ...
              const A = B(j).map(([se, le]) => [se, Object(S.a)(le, !1)]);
              return new Map(A);
            }(Q);
          }(W, M) : function(R, oe) {
        ...
        function K(N, M) {
          const W = N.path, R = M.start.path, oe = M.end.path, Q = [];
          return z(W, R) && Q.push({ offset: R[R.length - 1], isEnd: !1, presentation: M.presentation || null, type: M.type, name: M.name || null }), z(W, oe) && Q.push({ offset: oe[oe.length - 1], isEnd: !0, presentation: M.presentation || null, type: M.type, name: M.name || null }), Q;
        }
        function z(N, M) {
          return N.length === M.length - 1 && Object(o.a)(N, M) === "prefix";
        }
        function B(N) {
          return [...N.getAttributes()].sort(([M], [W]) => M.toUpperCase() < W.toUpperCase() ? -1 : 1);
        }
      }, function(b, a, u) {
        u.d(a, "d", function() {
          return y;
        ...
        function y(M) {
          if (!M) return [];
          const W = [...M.model.document.roots];
          return W.filter(({ rootName: R }) => R !== "$graveyard").concat(W.filter(({ rootName: R }) => R === "$graveyard"));
        }
        function v(M, W) {
          if (!M) return [];
          const R = [], oe = M.model;
          for (const Q of oe.document.selection.getRanges()) Q.root.rootName === W && R.push({ type: "selection", start: Object(c.a)(Q.start), end: Object(c.a)(Q.end) });
          return R;
        }
        function C(M, W) {
          if (!M) return [];
          ...
          for (const j of oe.markers) {
            ...
            te.root.rootName === W && R.push({ type: "marker", marker: j, name: A, affectsData: se, managedUsingOperations: le, presentation: { color: g[Q++ % (g.length - 1)] }, start: Object(c.a)(te), end: Object(c.a)(ce) });
          }
          return R;
        }
        function O({ currentEditor: M, currentRootName: W, ranges: R, markers: oe }) {
          return M ? [G(M.model.document.getRoot(W), [...R, ...oe])] : [];
        }
        function P(M, W) {
          const R = { editorNode: W, properties: {}, attributes: {} };
          Object(c.c)(W) ? (Object(c.d)(W) ? (R.type = "RootElement", R.name = W.rootName, R.url = m + "rootelement-RootElement.html") : (R.type = "Element", R.name = W.name, R.url = m + "element-Element.html"), R.properties = { childCount: { value: W.childCount }, startOffset: { value: W.startOffset }, endOffset: { value: W.endOffset }, maxOffset: { value: W.maxOffset } }) : (R.name = W.data, R.type = "Text", R.url = m + "text-Text.html", R.properties = { startOffset: { value: W.startOffset }, endOffset: { value: W.endOffset }, offsetSize: { value: W.offsetSize } }), R.properties.path = { value: Object(c.b)(W) }, z(W).forEach(([oe, Q]) => {
          ...
          for (const oe in R.attributes) {
            const Q = {}, j = M.model.schema.getAttributeProperties(oe);
            for (const A in j) Q[A] = { value: j[A] };
            R.attributes[oe].subProperties = Object(S.b)(Q);
          }
          return R;
        }
        function G(M, W) {
          const R = {}, { startOffset: oe, endOffset: Q } = M;
          return Object.assign(R, { startOffset: oe, endOffset: Q, node: M, path: M.getPath(), positionsBefore: [], positionsAfter: [] }), Object(c.c)(M) ? function(j, A) {
            const se = j.node;
            Object.assign(j, { type: "element", name: se.name, children: [], maxOffset: se.maxOffset, positions: [] });
            for (const le of se.getChildren()) j.children.push(G(le, A));
            (function(le, te) {
              for (const ce of te) {
                const ye = B(le, ce);
                for (const J of ye) {
        ...
        function K(M) {
          const W = z(M).map(([R, oe]) => [R, Object(S.a)(oe, !1)]);
          return new Map(W);
        }
        function z(M) {
          return [...M.getAttributes()].sort(([W], [R]) => W < R ? -1 : 1);
        }
        function B(M, W) {
          const R = M.path, oe = W.start.path, Q = W.end.path, j = [];
          return N(R, oe) && j.push({ offset: oe[oe.length - 1], isEnd: !1, presentation: W.presentation || null, type: W.type, name: W.name || null }), N(R, Q) && j.push({ offset: Q[Q.length - 1], isEnd: !0, presentation: W.presentation || null, type: W.type, name: W.name || null }), j;
        }
        function N(M, W) {
          return M.length === W.length - 1 && Object(o.a)(M, W) === "prefix";
        }
      }, function(b, a, u) {
        u.d(a, "a", function() {
          return z;
        });
        var c = u(0), o = u.n(c), S = u(5), m = u.n(S);
        ...
        class O extends g {
          render() {
            const N = this.definition, M = N.presentation, W = M && M.isEmpty, R = M && M.cssClass, oe = this.getChildren(), Q = ["ck-inspector-code", "ck-inspector-tree-node", this.isActive ? "ck-inspector-tree-node_active" : "", W ? "ck-inspector-tree-node_empty" : "", R], j = [], A = [];
        ...
        class P extends g {
          render() {
            ...
            let W = this.definition.text;
            N.positions && N.positions.length && (W = W.split(""), Array.from(N.positions).sort((oe, Q) => oe.offset < Q.offset ? -1 : oe.offset === Q.offset ? 0 : 1).reverse().forEach((oe, Q) => {
              W.splice(oe.offset - N.startOffset, 0, o.a.createElement(C, { key: "position" + Q, definition: oe }));
            }));
            const R = [W];
          ...
          getAttributes() {
            const N = [], M = this.definition, W = M.presentation, R = W && W.dontRenderAttributeValue;
            for (const [oe, Q] of M.attributes) N.push(o.a.createElement(v, { key: oe, name: oe, value: Q, dontRenderValue: R }));
        ...
        function K(B, N, M) {
          return B.type === "element" ? o.a.createElement(O, { key: N, definition: B, globalTreeProps: M }) : B.type === "text" ? o.a.createElement(P, { key: N, definition: B, globalTreeProps: M }) : B.type === "comment" ? o.a.createElement(G, { key: N, definition: B }) : void 0;
        }
        u(34);
        class z extends c.Component {
          render() {
            let N;
            return N = this.props.definition ? this.props.definition.map((M, W) => K(M, W, { onClick: this.props.onClick, showCompactText: this.props.showCompactText, showElementTypes: this.props.showElementTypes, activeNode: this.props.activeNode })) : "Nothing to show.", o.a.createElement("div", { className: ["ck-inspector-tree", ...this.props.className || [], this.props.textDirection ? "ck-inspector-tree_text-direction_" + this.props.textDirection : "", this.props.showCompactText ? "ck-inspector-tree_compact-text" : ""].join(" ") }, N);
          }
        }
      }, function(b, a, u) {
        (function c() {
...
`, "\\n"], ["\f", "\\f"], ["\r", "\\r"], ["'", "\\'"], ['"', '\\"'], ["\\", "\\\\"]]);
        ...
        a.quoteString = function(y) {
          return `'${y.replace(c, S)}'`;
        };
        ...
        function g(y) {
          return typeof y == "string" && !m.has(y) && a.IS_VALID_IDENTIFIER.test(y);
        }
        a.IS_VALID_IDENTIFIER = /^[A-Za-z_$][A-Za-z0-9_$]*$/, a.isValidVariableName = g, a.quoteKey = function(y, v) {
          return g(y) ? y : v(y);
        }, a.stringifyPath = function(y, v) {
          let C = "";
          for (const O of y) g(O) ? C += "." + O : C += `[${v(O)}]`;
          return C;
        };
      }, function(b, a) {
        function u(v, C, O, P) {
          var G, K = (G = P) == null || typeof G == "number" || typeof G == "boolean" ? P : O(P), z = C.get(K);
          return z === void 0 && (z = v.call(this, P), C.set(K, z)), z;
        }
        function c(v, C, O) {
          var P = Array.prototype.slice.call(arguments, 3), G = O(P), K = C.get(G);
          return K === void 0 && (K = v.apply(this, P), C.set(G, K)), K;
        }
        function o(v, C, O, P, G) {
          return O.bind(C, v, P, G);
        }
        function S(v, C) {
        ...
        g.prototype.has = function(v) {
          return v in this.cache;
        }, g.prototype.get = function(v) {
          return this.cache[v];
        }, g.prototype.set = function(v, C) {
          this.cache[v] = C;
        };
        var y = { create: function() {
          return new g();
        } };
        b.exports = function(v, C) {
          var O = C && C.cache ? C.cache : y, P = C && C.serializer ? C.serializer : m;
          return (C && C.strategy ? C.strategy : S)(v, { cache: O, serializer: P });
        }, b.exports.strategies = { variadic: function(v, C) {
        ...
        var c = Object.getOwnPropertySymbols, o = Object.prototype.hasOwnProperty, S = Object.prototype.propertyIsEnumerable;
        function m(g) {
        ...
        b.exports = function() {
          ...
          for (var v, C, O = m(g), P = 1; P < arguments.length; P++) {
            for (var G in v = Object(arguments[P])) o.call(v, G) && (O[G] = v[G]);
            if (c) {
              C = c(v);
              for (var K = 0; K < C.length; K++) S.call(v, C[K]) && (O[C[K]] = v[C[K]]);
            }
          }
          return O;
        };
...
`).slice(1)) {
            ...
            if (!G) return C;
            const [K] = G;
            (O === void 0 || K.length < O.length) && (O = K);
          }
          return O ? C.split(`
` + O).join(`
`) : C;
        }
        a.functionToString = (C, O, P, G) => {
          const K = typeof G == "string" ? G : void 0;
          return K !== void 0 && a.USED_METHOD_KEY.add(C), new v(C, O, P, K).stringify();
        }, a.dedentFunction = y;
        class v {
          constructor(O, P, G, K) {
            this.fn = O, this.indent = P, this.next = G, this.key = K, this.pos = 0, this.hadKeyword = !1, this.fnString = Function.prototype.toString.call(O), this.fnType = O.constructor.name, this.keyQuote = K === void 0 ? "" : c.quoteKey(K, G), this.keyPrefix = K === void 0 ? "" : `${this.keyQuote}:${P ? " " : ""}`, this.isMethodCandidate = K !== void 0 && (this.fn.name === "" || this.fn.name === K);
          }
          stringify() {
          ...
          tryStrippingName() {
            ...
            if (P === this.fn.name && (this.pos += P.length, this.consumeSyntax() === "()" && this.consumeSyntax() === "{}" && this.pos === this.fnString.length)) return !this.isMethodCandidate && c.isValidVariableName(P) || (O += P.length), this.getPrefix() + this.fnString.substr(O);
            this.pos = O;
          }
          ...
          consumeSyntax(O) {
            ...
            if (!P) return;
            const [G, K] = P;
            if (this.consumeWhitespace(), K) return O || K;
            switch (G) {
              case "(":
          ...
          consumeSyntaxUntil(O, P) {
            ...
            for (; ; ) {
              ...
              if (K === P) return O + P;
              if (!K || K === ")" || K === "]" || K === "}") return;
              K === "/" && G && this.consumeMatch(/^(?:\\.|[^\\\/\n[]|\[(?:\\.|[^\]])*\])+\/[a-z]*/) ? (G = !1, this.consumeWhitespace()) : G = g.has(K);
            }
          }
          consumeMatch(O) {
          ...
          consumeRegExp(O, P) {
            const G = O.exec(this.fnString.substr(this.pos));
            if (G) return this.pos += G[0].length, this.consumeWhitespace(), P;
          }
          consumeTemplate() {
            for (; ; ) {
        ...
        const c = u(25), o = u(13), S = Symbol("root");
        a.stringify = function(m, g, y, v = {}) {
          const C = typeof y == "string" ? y : " ".repeat(y || 0), O = [], P = /* @__PURE__ */ new Set(), G = /* @__PURE__ */ new Map(), K = /* @__PURE__ */ new Map();
          let z = 0;
          const { maxDepth: B = 100, references: N = !1, skipUndefinedProperties: M = !1, maxValues: W = 1e5 } = v, R = function(A) {
            return A ? (se, le, te, ce) => A(se, le, (ye) => c.toString(ye, le, te, ce), ce) : c.toString;
          }(g), oe = (A, se) => {
            if (++z > W || M && A === void 0 || O.length > B) return;
            if (se === void 0) return R(A, C, oe, se);
            O.push(se);
            const le = Q(A, se === S ? void 0 : se);
            return O.pop(), le;
          }, Q = N ? (A, se) => {
            if (A !== null && (typeof A == "object" || typeof A == "function" || typeof A == "symbol")) {
              if (G.has(A)) return K.set(O.slice(1), G.get(A)), R(void 0, C, oe, se);
              G.set(A, O.slice(1));
            }
            return R(A, C, oe, se);
          } : (A, se) => {
...
` : "";
        ...
        Object.defineProperty(a, "__esModule", { value: !0 }), a.findInArray = function(c, o) {
          for (var S = 0, m = c.length; S < m; S++) if (o.apply(o, [c[S], S, c])) return c[S];
        ...
        }, a.dontSetMe = function(c, o, S) {
          if (c[o]) return new Error("Invalid prop ".concat(o, " passed to ").concat(S, " - do not set this, set it on the child."));
        };
      }, function(b, a, u) {
        var c = u(16), o = typeof Symbol == "function" && Symbol.for, S = o ? Symbol.for("react.element") : 60103, m = o ? Symbol.for("react.portal") : 60106, g = o ? Symbol.for("react.fragment") : 60107, y = o ? Symbol.for("react.strict_mode") : 60108, v = o ? Symbol.for("react.profiler") : 60114, C = o ? Symbol.for("react.provider") : 60109, O = o ? Symbol.for("react.context") : 60110, P = o ? Symbol.for("react.forward_ref") : 60112, G = o ? Symbol.for("react.suspense") : 60113, K = o ? Symbol.for("react.memo") : 60115, z = o ? Symbol.for("react.lazy") : 60116, B = typeof Symbol == "function" && Symbol.iterator;
        function N(X) {
        ...
        function R(X, Y, me) {
          this.props = X, this.context = Y, this.refs = W, this.updater = me || M;
        }
        function oe() {
        }
        function Q(X, Y, me) {
        ...
        R.prototype.isReactComponent = {}, R.prototype.setState = function(X, Y) {
          if (typeof X != "object" && typeof X != "function" && X != null) throw Error(N(85));
        ...
        function te(X, Y, me) {
          ...
          return { $$typeof: S, type: X, key: w, ref: U, props: f, _owner: A.current };
        }
        function ce(X) {
        ...
        function ie(X, Y, me) {
          return X == null ? 0 : function l(f, w, U, F) {
            ...
            if (he = 0, w = w === "" ? "." : w + ":", Array.isArray(f)) for (var je = 0; je < f.length; je++) {
              var Re = w + be(H = f[je], je);
              he += l(H, Re, U, F);
            }
            else if (f === null || typeof f != "object" ? Re = null : Re = typeof (Re = B && f[B] || f["@@iterator"]) == "function" ? Re : null, typeof Re == "function") for (f = Re.call(f), je = 0; !(H = f.next()).done; ) he += l(H = H.value, Re = w + be(H, je++), U, F);
            else if (H === "object") throw U = "" + f, Error(N(31, U === "[object Object]" ? "object with keys {" + Object.keys(f).join(", ") + "}" : U, ""));
            return he;
          }(X, "", Y, me);
        }
        function be(X, Y) {
        ...
        function we(X, Y, me) {
          ...
          X = X.func.call(X.context, Y, X.count++), Array.isArray(X) ? Ne(X, l, me, function(w) {
            return w;
          }) : X != null && (ce(X) && (X = function(w, U) {
            return { $$typeof: S, type: w.type, key: U, ref: w.ref, props: w.props, _owner: w._owner };
          }(X, f + (!X.key || Y && Y.key === X.key ? "" : ("" + X.key).replace(ye, "$&/") + "/") + me)), l.push(X));
        }
        function Ne(X, Y, me, l, f) {
          var w = "";
        ...
        a.Children = { map: function(X, Y, me) {
          if (X == null) return X;
          var l = [];
          return Ne(X, l, null, Y, me), l;
          ...
          var Y = [];
          return Ne(X, Y, null, function(me) {
            return me;
          }), Y;
        }, only: function(X) {
          if (!ce(X)) throw Error(N(143));
          return X;
        } }, a.Component = R, a.Fragment = g, a.Profiler = v, a.PureComponent = Q, a.StrictMode = y, a.Suspense = G, a.__SECRET_INTERNALS_DO_NOT_USE_OR_YOU_WILL_BE_FIRED = Je, a.cloneElement = function(X, Y, me) {
          if (X == null) throw Error(N(267, X));
          var l = c({}, X.props), f = X.key, w = X.ref, U = X._owner;
          if (Y != null) {
            if (Y.ref !== void 0 && (w = Y.ref, U = A.current), Y.key !== void 0 && (f = "" + Y.key), X.type && X.type.defaultProps) var F = X.type.defaultProps;
          ...
          return { $$typeof: S, type: X.type, key: f, ref: w, props: l, _owner: U };
        }, a.createContext = function(X, Y) {
          return Y === void 0 && (Y = null), (X = { $$typeof: O, _calculateChangedBits: Y, _currentValue: X, _currentValue2: X, _threadCount: 0, Provider: null, Consumer: null }).Provider = { $$typeof: C, _context: X }, X.Consumer = X;
        }, a.createElement = te, a.createFactory = function(X) {
          var Y = te.bind(null, X);
          return Y.type = X, Y;
        }, a.createRef = function() {
          return { current: null };
        }, a.forwardRef = function(X) {
          return { $$typeof: P, render: X };
        }, a.isValidElement = ce, a.lazy = function(X) {
          return { $$typeof: z, _ctor: X, _status: -1, _result: null };
        }, a.memo = function(X, Y) {
          return { $$typeof: K, type: X, compare: Y === void 0 ? null : Y };
        }, a.useCallback = function(X, Y) {
          return ze().useCallback(X, Y);
        }, a.useContext = function(X, Y) {
          return ze().useContext(X, Y);
        }, a.useDebugValue = function() {
        }, a.useEffect = function(X, Y) {
          return ze().useEffect(X, Y);
        }, a.useImperativeHandle = function(X, Y, me) {
          return ze().useImperativeHandle(X, Y, me);
        }, a.useLayoutEffect = function(X, Y) {
          return ze().useLayoutEffect(X, Y);
        }, a.useMemo = function(X, Y) {
          return ze().useMemo(X, Y);
        }, a.useReducer = function(X, Y, me) {
          return ze().useReducer(X, Y, me);
        }, a.useRef = function(X) {
          return ze().useRef(X);
        }, a.useState = function(X) {
          return ze().useState(X);
        }, a.version = "16.14.0";
      }, function(b, a, u) {
        var c = u(0), o = u(16), S = u(23);
        function m(e) {
          for (var t = "https://reactjs.org/docs/error-decoder.html?invariant=" + e, n = 1; n < arguments.length; n++) t += "&args[]=" + encodeURIComponent(arguments[n]);
          return "Minified React error #" + e + "; visit " + t + " for the full message or use the non-minified dev environment for full errors and additional helpful warnings.";
        }
        if (!c) throw Error(m(227));
        function g(e, t, n, r, i, p, k, x, Z) {
        ...
        var y = !1, v = null, C = !1, O = null, P = { onError: function(e) {
          y = !0, v = e;
        } };
        function G(e, t, n, r, i, p, k, x, Z) {
          y = !1, v = null, g.apply(P, arguments);
        }
        var K = null, z = null, B = null;
        function N(e, t, n) {
          var r = e.type || "unknown-event";
          e.currentTarget = B(n), function(i, p, k, x, Z, q, ge, De, He) {
            if (G.apply(this, arguments), y) {
              if (!y) throw Error(m(198));
              var ot = v;
              y = !1, v = null, C || (C = !0, O = ot);
            }
        ...
        function R() {
          if (M) for (var e in W) {
            var t = W[e], n = M.indexOf(e);
            if (!(-1 < n)) throw Error(m(96, e));
            if (!Q[n]) {
              if (!t.extractEvents) throw Error(m(97, e));
              for (var r in Q[n] = t, n = t.eventTypes) {
                var i = void 0, p = n[r], k = t, x = r;
                if (j.hasOwnProperty(x)) throw Error(m(99, x));
                j[x] = p;
                var Z = p.phasedRegistrationNames;
                if (Z) {
                  for (i in Z) Z.hasOwnProperty(i) && oe(Z[i], k, x);
                  i = !0;
                } else p.registrationName ? (oe(p.registrationName, k, x), i = !0) : i = !1;
        ...
        function je(e, t, n, r) {
          ...
          (i !== null ? i.type === 0 : !r && 2 < t.length && (t[0] === "o" || t[0] === "O") && (t[1] === "n" || t[1] === "N")) || (function(p, k, x, Z) {
            if (k == null || function(q, ge, De, He) {
    ...
    in ` + (r || "Unknown") + p;
        ...
        function rt(e) {
          if (!(e = function(n) {
            ...
            for (var i = n, p = r; ; ) {
              ...
              if (k.child === x.child) {
                for (x = k.child; x; ) {
                  if (x === i) return _o(k), n;
                  if (x === p) return _o(k), r;
                  x = x.sibling;
                }
                throw Error(m(188));
              }
              if (i.return !== p.return) i = k, p = x;
              else {
        ...
        function rn(e) {
          ...
          for (n = 0; n < e.ancestors.length; n++) {
            ...
            n === 0 && (k |= 64);
            for (var x = null, Z = 0; Z < Q.length; Z++) {
              var q = Q[Z];
              q && (q = q.extractEvents(r, t, p, i, k)) && (x = Ue(x, q));
            }
            Mt(x);
          }
        }
        ...
        function vi() {
          ...
          Vt !== null && So(Vt) && (Vt = null), on !== null && So(on) && (on = null), Kn !== null && So(Kn) && (Kn = null), fr.forEach(yi), Zr.forEach(yi);
        }
        function Dr(e, t) {
        ...
        function pr(e) {
          ...
          for (Vt !== null && Dr(Vt, e), on !== null && Dr(on, e), Kn !== null && Dr(Kn, e), fr.forEach(t), Zr.forEach(t), n = 0; n < Nr.length; n++) (r = Nr[n]).blockedOn === e && (r.blockedOn = null);
          for (; 0 < Nr.length && (n = Nr[0]).blockedOn === null; ) Sa(n), n.blockedOn === null && Nr.shift();
        }
        var ki = {}, wi = /* @__PURE__ */ new Map(), Rr = /* @__PURE__ */ new Map(), Ca = ["abort", "abort", tn, "animationEnd", ht, "animationIteration", Wt, "animationStart", "canplay", "canPlay", "canplaythrough", "canPlayThrough", "durationchange", "durationChange", "emptied", "emptied", "encrypted", "encrypted", "ended", "ended", "error", "error", "gotpointercapture", "gotPointerCapture", "load", "load", "loadeddata", "loadedData", "loadedmetadata", "loadedMetadata", "loadstart", "loadStart", "lostpointercapture", "lostPointerCapture", "playing", "playing", "progress", "progress", "seeking", "seeking", "stalled", "stalled", "suspend", "suspend", "timeupdate", "timeUpdate", Nn, "transitionEnd", "waiting", "waiting"];
        function Yo(e, t) {
        ...
        var Ta = S.unstable_UserBlockingPriority, Oa = S.unstable_runWithPriority, Co = !0;
        function mt(e, t) {
          Jr(t, e, !1);
        }
        function Jr(e, t, n) {
        ...
        function To(e, t, n, r) {
          if (Co) if (0 < Ut.length && -1 < Wn.indexOf(e)) e = xo(null, e, t, n, r), Ut.push(e);
          else {
            var i = Ar(e, t, n, r);
            if (i === null) kn(e, r);
            else if (-1 < Wn.indexOf(e)) e = xo(i, e, t, n, r), Ut.push(e);
            else if (!function(p, k, x, Z, q) {
              switch (k) {
                case "focus":
                  return Vt = Pr(Vt, p, k, x, Z, q), !0;
                case "dragenter":
                  return on = Pr(on, p, k, x, Z, q), !0;
                case "mouseover":
                  return Kn = Pr(Kn, p, k, x, Z, q), !0;
                case "pointerover":
                  var ge = q.pointerId;
                  return fr.set(ge, Pr(fr.get(ge) || null, p, k, x, Z, q)), !0;
                case "gotpointercapture":
                  return ge = q.pointerId, Zr.set(ge, Pr(Zr.get(ge) || null, p, k, x, Z, q)), !0;
              }
              return !1;
            }(i, e, t, n, r)) {
        ...
        var s = an.extend({ data: null }), d = an.extend({ data: null }), h = [9, 13, 27, 32], _ = te && "CompositionEvent" in window, T = null;
        te && "documentMode" in document && (T = document.documentMode);
        var L = te && "TextEvent" in window && !T, ne = te && (!_ || T && 8 < T && 11 >= T), fe = " ", pe = { beforeInput: { phasedRegistrationNames: { bubbled: "onBeforeInput", captured: "onBeforeInputCapture" }, dependencies: ["compositionend", "keypress", "textInput", "paste"] }, compositionEnd: { phasedRegistrationNames: { bubbled: "onCompositionEnd", captured: "onCompositionEndCapture" }, dependencies: "blur compositionend keydown keypress keyup mousedown".split(" ") }, compositionStart: { phasedRegistrationNames: { bubbled: "onCompositionStart", captured: "onCompositionStartCapture" }, dependencies: "blur compositionstart keydown keypress keyup mousedown".split(" ") }, compositionUpdate: { phasedRegistrationNames: { bubbled: "onCompositionUpdate", captured: "onCompositionUpdateCapture" }, dependencies: "blur compositionupdate keydown keypress keyup mousedown".split(" ") } }, Ee = !1;
        function Pe(e, t) {
          switch (e) {
            case "keyup":
        ...
        var Ae = !1, Ke = { eventTypes: pe, extractEvents: function(e, t, n, r) {
          ...
          return p ? (ne && n.locale !== "ko" && (Ae || p !== pe.compositionStart ? p === pe.compositionEnd && Ae && (i = Ii()) : (ri = "value" in (hr = r) ? hr.value : hr.textContent, Ae = !0)), p = s.getPooled(p, t, n, r), (i || (i = We(n)) !== null) && (p.data = i), jr(p), i = p) : i = null, (e = L ? function(k, x) {
            switch (k) {
              case "compositionend":
                return We(x);
              case "keypress":
                return x.which !== 32 ? null : (Ee = !0, fe);
              case "textInput":
                return (k = x.data) === fe && Ee ? null : k;
              default:
                return null;
            }
          }(e, n) : function(k, x) {
            if (Ae) return k === "compositionend" || !_ && Pe(k, x) ? (k = Ii(), Do = ri = hr = null, Ae = !1, k) : null;
            switch (k) {
              case "paste":
                return null;
              case "keypress":
        ...
        var dn = 0, Xn = 0, Gt = !1, fn = !1, Lr = xt.extend({ screenX: null, screenY: null, clientX: null, clientY: null, pageX: null, pageY: null, ctrlKey: null, shiftKey: null, altKey: null, metaKey: null, getModifierState: $t, button: null, buttons: null, relatedTarget: function(e) {
          ...
          if (e === "mouseout" || e === "mouseover") var x = Lr, Z = Ur.mouseLeave, q = Ur.mouseEnter, ge = "mouse";
          else e !== "pointerout" && e !== "pointerover" || (x = oi, Z = Ur.pointerLeave, q = Ur.pointerEnter, ge = "pointer");
          if (e = k == null ? p : Gn(k), p = t == null ? p : Gn(t), (Z = x.getPooled(Z, k, n, r)).type = ge + "leave", Z.target = e, Z.relatedTarget = p, (n = x.getPooled(q, t, n, r)).type = ge + "enter", n.target = p, n.relatedTarget = e, ge = t, (r = k) && ge) e: {
            for (q = ge, k = 0, e = x = r; e; e = Rn(e)) k++;
          ...
          for (q = x, x = []; r && r !== q && ((k = r.alternate) === null || k !== q); ) x.push(r), r = Rn(r);
          for (r = []; ge && ge !== q && ((k = ge.alternate) === null || k !== q); ) r.push(ge), ge = Rn(ge);
          for (ge = 0; ge < x.length; ge++) Po(x[ge], "bubbled", Z);
        ...
        var oc = { eventTypes: ii, extractEvents: function(e, t, n, r, i, p) {
        ...
        M = Array.prototype.slice.call("ResponderEventPlugin SimpleEventPlugin EnterLeaveEventPlugin ChangeEventPlugin SelectEventPlugin BeforeInputEventPlugin".split(" ")), R(), K = ni, z = oo, B = Gn, le({ SimpleEventPlugin: mc, EnterLeaveEventPlugin: Mo, ChangeEventPlugin: zr, SelectEventPlugin: oc, BeforeInputEventPlugin: Ke });
        var Aa = [], jo = -1;
        function vt(e) {
        ...
        var gc = S.unstable_runWithPriority, Ma = S.unstable_scheduleCallback, As = S.unstable_cancelCallback, Ms = S.unstable_requestPaint, Ia = S.unstable_now, bc = S.unstable_getCurrentPriorityLevel, Bi = S.unstable_ImmediatePriority, Is = S.unstable_UserBlockingPriority, js = S.unstable_NormalPriority, zs = S.unstable_LowPriority, Ls = S.unstable_IdlePriority, Us = {}, yc = S.unstable_shouldYield, vc = Ms !== void 0 ? Ms : function() {
        }, br = null, Wi = null, ja = !1, Fs = Ia(), jn = 1e4 > Fs ? Ia : function() {
          return Ia() - Fs;
        };
        function Hi() {
          switch (bc()) {
        ...
        function Hs(e) {
          return br === null ? (br = [e], Wi = Ma(Bi, Vs)) : br.push(e), Us;
        }
        function Jn() {
          if (Wi !== null) {
            var e = Wi;
        ...
        function ai(e, t, n, r) {
          ...
          if (k !== null) {
            if (p !== null) {
              var x = p.next;
              p.next = k.next, k.next = x;
            }
            p = k, i.shared.pending = null, (x = e.alternate) !== null && (x = x.updateQueue) !== null && (x.baseQueue = k);
          }
          if (p !== null) {
            x = p.next;
            var Z = i.baseState, q = 0, ge = null, De = null, He = null;
            if (x !== null) for (var ot = x; ; ) {
              if ((k = ot.expirationTime) < r) {
                ...
                He === null ? (De = He = Fn, ge = Z) : He = He.next = Fn, k > q && (q = k);
              } else {
                He !== null && (He = He.next = { expirationTime: 1073741823, suspenseConfig: ot.suspenseConfig, tag: ot.tag, payload: ot.payload, callback: ot.callback, next: null }), Bl(k, ot.suspenseConfig);
                e: {
                  var ln = e, re = ot;
              ...
              if ((ot = ot.next) === null || ot === x) {
                ...
                ot = p.next = k.next, k.next = x, i.baseQueue = p = k, i.shared.pending = null;
              }
            }
            He === null ? ge = Z : He.next = De, i.baseState = ge, i.baseQueue = He, va(q), e.expirationTime = q, e.memoizedState = Z;
          }
        }
        function qs(e, t, n) {
        ...
        function Zs(e) {
          ...
          function Z(re, ee, ue, ve) {
            return ee !== null && ee.elementType === ue.type ? ((ve = i(ee, ue.props)).ref = li(re, ee, ue), ve.return = re, ve) : ((ve = ka(ue.type, ue.key, ue.props, null, re.mode, ve)).ref = li(re, ee, ue), ve.return = re, ve);
          }
          ...
          function De(re, ee, ue) {
            ...
            if (typeof ee == "object" && ee !== null) {
              switch (ee.$$typeof) {
                case Ve:
                  return (ue = ka(ee.type, ee.key, ee.props, null, re.mode, ue)).ref = li(re, null, ee), ue.return = re, ue;
                case At:
            ...
            if (Oe) switch (ue.$$typeof) {
              case Ve:
                e: {
                  ...
                  ue.type === kt ? ((ee = Qr(ue.props.children, re.mode, ve, ue.key)).return = re, re = ee) : ((ve = ka(ue.type, ue.key, ue.props, null, re.mode, ve)).ref = li(re, ee, ue), ve.return = re, re = ve);
                }
                return k(re);
              case At:
                e: {
          ...
          if (i !== null) {
            ...
            do {
              ...
              if (q < $r) {
                ...
                x === null ? (k = x = ge, p = r) : x = x.next = ge, q > Lt.expirationTime && (Lt.expirationTime = q, va(q));
              } else x !== null && (x = x.next = { expirationTime: 1073741823, suspenseConfig: Z.suspenseConfig, action: Z.action, eagerReducer: Z.eagerReducer, eagerState: Z.eagerState, next: null }), Bl(q, Z.suspenseConfig), r = Z.eagerReducer === e ? Z.eagerState : e(r, Z.action);
              Z = Z.next;
            } while (Z !== null && Z !== i);
            x === null ? p = r : x.next = k, mr(r, t.memoizedState) || (tr = !0), t.memoizedState = r, t.baseState = p, t.baseQueue = x, n.lastRenderedState = r;
          }
        ...
        function sl(e, t, n) {
          ...
          if (p === null ? i.next = i : (i.next = p.next, p.next = i), t.pending = i, p = e.alternate, e === Lt || p !== null && p === Lt) ea = !0, i.expirationTime = $r, Lt.expirationTime = $r;
            ...
            if (e.expirationTime === 0 && (p === null || p.expirationTime === 0) && (p = t.lastRenderedReducer) !== null) try {
              var k = t.lastRenderedState, x = p(k, n);
              if (i.eagerReducer = p, i.eagerState = x, mr(x, k)) return;
            } catch {
            }
            Kr(e, r);
          }
        ...
        function ml(e, t, n, r, i) {
          ...
          if (Uo(t, i), t.stateNode === null) e !== null && (e.alternate = null, t.alternate = null, t.effectTag |= 2), Gs(t, n, r), Ba(t, n, r, i), r = !0;
            ...
            var k = t.stateNode, x = t.memoizedProps;
            k.props = x;
            ...
            De || typeof k.UNSAFE_componentWillReceiveProps != "function" && typeof k.componentWillReceiveProps != "function" || (x !== r || Z !== q) && Xs(t, k, r, q), Wr = !1;
            var He = t.memoizedState;
            k.state = He, ai(t, r, k, i), Z = t.memoizedState, x !== r || He !== Z || pn.current || Wr ? (typeof ge == "function" && (Ki(t, n, ge, r), Z = t.memoizedState), (x = Wr || Qs(t, n, x, r, He, Z, q)) ? (De || typeof k.UNSAFE_componentWillMount != "function" && typeof k.componentWillMount != "function" || (typeof k.componentWillMount == "function" && k.componentWillMount(), typeof k.UNSAFE_componentWillMount == "function" && k.UNSAFE_componentWillMount()), typeof k.componentDidMount == "function" && (t.effectTag |= 4)) : (typeof k.componentDidMount == "function" && (t.effectTag |= 4), t.memoizedProps = r, t.memoizedState = Z), k.props = r, k.state = Z, k.context = q, r = x) : (typeof k.componentDidMount == "function" && (t.effectTag |= 4), r = !1);
          } else k = t.stateNode, Fa(e, t), x = t.memoizedProps, k.props = t.type === t.elementType ? x : $n(t.type, x), Z = k.context, typeof (q = n.contextType) == "object" && q !== null ? q = zn(q) : q = zo(t, q = hn(n) ? lo : Xt.current), (De = typeof (ge = n.getDerivedStateFromProps) == "function" || typeof k.getSnapshotBeforeUpdate == "function") || typeof k.UNSAFE_componentWillReceiveProps != "function" && typeof k.componentWillReceiveProps != "function" || (x !== r || Z !== q) && Xs(t, k, r, q), Wr = !1, Z = t.memoizedState, k.state = Z, ai(t, r, k, i), He = t.memoizedState, x !== r || Z !== He || pn.current || Wr ? (typeof ge == "function" && (Ki(t, n, ge, r), He = t.memoizedState), (ge = Wr || Qs(t, n, x, r, Z, He, q)) ? (De || typeof k.UNSAFE_componentWillUpdate != "function" && typeof k.componentWillUpdate != "function" || (typeof k.componentWillUpdate == "function" && k.componentWillUpdate(r, He, q), typeof k.UNSAFE_componentWillUpdate == "function" && k.UNSAFE_componentWillUpdate(r, He, q)), typeof k.componentDidUpdate == "function" && (t.effectTag |= 4), typeof k.getSnapshotBeforeUpdate == "function" && (t.effectTag |= 256)) : (typeof k.componentDidUpdate != "function" || x === e.memoizedProps && Z === e.memoizedState || (t.effectTag |= 4), typeof k.getSnapshotBeforeUpdate != "function" || x === e.memoizedProps && Z === e.memoizedState || (t.effectTag |= 256), t.memoizedProps = r, t.memoizedState = He), k.props = r, k.state = He, k.context = q, r = ge) : (typeof k.componentDidUpdate != "function" || x === e.memoizedProps && Z === e.memoizedState || (t.effectTag |= 4), typeof k.getSnapshotBeforeUpdate != "function" || x === e.memoizedProps && Z === e.memoizedState || (t.effectTag |= 256), r = !1);
        ...
        function rs(e, t, n, r, i, p) {
          ...
          var x = k && typeof n.getDerivedStateFromError != "function" ? null : r.render();
          return t.effectTag |= 1, e !== null && k ? (t.child = Fo(t, e.child, null, p), t.child = Fo(t, null, x, p)) : Un(e, t, x, p), t.memoizedState = r.state, i && Rs(t, n, !0), t.child;
        }
        function gl(e) {
          var t = e.stateNode;
          t.pendingContext ? Ps(0, t.pendingContext, t.pendingContext !== t.context) : t.context && Ps(0, t.context, !1), Ha(e, t.containerInfo);
        }
        var bl, yl, vl, os = { dehydrated: null, retryTime: 0 };
        function kl(e, t, n) {
          var r, i = t.mode, p = t.pendingProps, k = Ct.current, x = !1;
          if ((r = (64 & t.effectTag) != 0) || (r = (2 & k) != 0 && (e === null || e.memoizedState !== null)), r ? (x = !0, t.effectTag &= -65) : e !== null && e.memoizedState === null || p.fallback === void 0 || p.unstable_avoidThisFallback === !0 || (k |= 1), St(Ct, 1 & k), e === null) {
            if (p.fallback !== void 0 && es(t), x) {
              ...
              return (n = Qr(x, i, n, null)).return = t, p.sibling = n, t.memoizedState = os, t.child = p, n;
            }
          ...
          if (e = e.child, x) {
            ...
            return (n = Qr(x, i, n, null)).return = t, p.sibling = n, n.effectTag |= 2, p.childExpirationTime = 0, t.memoizedState = os, t.child = p, n;
          }
          ...
          switch (t.tag) {
            ...
            case 5:
              ...
              if (e !== null && t.stateNode != null) yl(e, t, i, r, n), e.ref !== t.ref && (t.effectTag |= 128);
                ...
                if (e = co(er.current), aa(t)) {
                  ...
                  for (var k in Ko(i, p), e = null, p) if (p.hasOwnProperty(k)) {
                    var x = p[k];
                    k === "children" ? typeof x == "string" ? r.textContent !== x && (e = ["children", x]) : typeof x == "number" && r.textContent !== "" + x && (e = ["children", "" + x]) : A.hasOwnProperty(k) && x != null && Hn(n, k);
                  }
                  switch (i) {
                    case "input":
                      Sr(r), ar(r, p, !0);
                  ...
                  switch (k = n.nodeType === 9 ? n : n.ownerDocument, e === Ci && (e = ke(i)), e === Ci ? i === "script" ? ((e = k.createElement("div")).innerHTML = "<script><\/script>", e = e.removeChild(e.firstChild)) : typeof r.is == "string" ? e = k.createElement(i, { is: r.is }) : (e = k.createElement(i), i === "select" && (k = e, r.multiple ? k.multiple = !0 : r.size && (k.size = r.size))) : e = k.createElementNS(e, i), e[Qn] = t, e[no] = r, bl(e, t), t.stateNode = e, k = Qo(i, r), i) {
                    case "iframe":
                    case "object":
                    case "embed":
                      mt("load", e), x = r;
                    ...
                    case "details":
                      ...
                      break;
                    case "input":
                      bn(e, r), x = Cr(e, r), mt("invalid", e), Hn(n, "onChange");
                      break;
                    case "option":
                      x = sr(e, r);
                      break;
                    case "select":
                      e._wrapperState = { wasMultiple: !!r.multiple }, x = o({}, r, { value: void 0 }), mt("invalid", e), Hn(n, "onChange");
                      break;
                    case "textarea":
                      On(e, r), x = lr(e, r), mt("invalid", e), Hn(n, "onChange");
                      break;
                    default:
                      x = r;
                  }
                  ...
                  for (p in Z) if (Z.hasOwnProperty(p)) {
                    var q = Z[p];
                    p === "style" ? xi(e, q) : p === "dangerouslySetInnerHTML" ? (q = q ? q.__html : void 0) != null && qe(e, q) : p === "children" ? typeof q == "string" ? (i !== "textarea" || q !== "") && st(e, q) : typeof q == "number" && st(e, "" + q) : p !== "suppressContentEditableWarning" && p !== "suppressHydrationWarning" && p !== "autoFocus" && (A.hasOwnProperty(p) ? q != null && Hn(n, p) : q != null && je(e, p, q, k));
                  }
                  switch (i) {
                    case "input":
                      Sr(e), ar(e, r, !1);
            ...
            case 6:
              if (e && t.stateNode != null) vl(0, t, e.memoizedProps, r);
                ...
                n = co(di.current), co(er.current), aa(t) ? (n = t.stateNode, r = t.memoizedProps, n[Qn] = t, n.nodeValue !== r && (t.effectTag |= 4)) : ((n = (n.nodeType === 9 ? n : n.ownerDocument).createTextNode(r))[Qn] = t, t.stateNode = n);
              }
              return null;
            case 13:
              return vt(Ct), r = t.memoizedState, 64 & t.effectTag ? (t.expirationTime = n, t) : (n = r !== null, r = !1, e === null ? t.memoizedProps.fallback !== void 0 && aa(t) : (r = (i = e.memoizedState) !== null, n || i === null || (i = e.child.sibling) !== null && ((p = t.firstEffect) !== null ? (t.firstEffect = i, i.nextEffect = p) : (t.firstEffect = t.lastEffect = i, i.nextEffect = null), i.effectTag = 8)), n && !r && 2 & t.mode && (e === null && t.memoizedProps.unstable_avoidThisFallback !== !0 || 1 & Ct.current ? Ft === po && (Ft = ca) : (Ft !== po && Ft !== ca || (Ft = ua), pi !== 0 && _n !== null && (ko(_n, mn), Yl(_n, pi)))), (n || r) && (t.effectTag |= 4), null);
            case 4:
              return Bo(), null;
            case 10:
              return La(t), null;
        ...
        bl = function(e, t) {
          ...
          if (p !== r) {
            ...
            for (k in Ko(n, r), n = null, p) if (!r.hasOwnProperty(k) && p.hasOwnProperty(k) && p[k] != null) if (k === "style") for (x in Z = p[k]) Z.hasOwnProperty(x) && (n || (n = {}), n[x] = "");
            ...
            for (k in r) {
              ...
              if (Z = p != null ? p[k] : void 0, r.hasOwnProperty(k) && q !== Z && (q != null || Z != null)) if (k === "style") if (Z) {
                for (x in Z) !Z.hasOwnProperty(x) || q && q.hasOwnProperty(x) || (n || (n = {}), n[x] = "");
                for (x in q) q.hasOwnProperty(x) && Z[x] !== q[x] && (n || (n = {}), n[x] = q[x]);
              } else n || (e || (e = []), e.push(k, n)), n = q;
              else k === "dangerouslySetInnerHTML" ? (q = q ? q.__html : void 0, Z = Z ? Z.__html : void 0, q != null && Z !== q && (e = e || []).push(k, q)) : k === "children" ? Z === q || typeof q != "string" && typeof q != "number" || (e = e || []).push(k, "" + q) : k !== "suppressContentEditableWarning" && k !== "suppressHydrationWarning" && (A.hasOwnProperty(k) ? (q != null && Hn(i, k), e || Z === q || (e = [])) : (e = e || []).push(k, q));
            }
        ...
        function Nl(e) {
          ...
          r ? function i(p, k, x) {
            ...
            if (q) p = q ? p.stateNode : p.stateNode.instance, k ? x.nodeType === 8 ? x.parentNode.insertBefore(p, k) : x.insertBefore(p, k) : (x.nodeType === 8 ? (k = x.parentNode).insertBefore(p, x) : (k = x).appendChild(p), (x = x._reactRootContainer) !== null && x !== void 0 || k.onclick !== null || (k.onclick = Oo));
            else if (Z !== 4 && (p = p.child) !== null) for (i(p, k, x), p = p.sibling; p !== null; ) i(p, k, x), p = p.sibling;
          }(e, n, t) : function i(p, k, x) {
            var Z = p.tag, q = Z === 5 || Z === 6;
            if (q) p = q ? p.stateNode : p.stateNode.instance, k ? x.insertBefore(p, k) : x.appendChild(p);
            else if (Z !== 4 && (p = p.child) !== null) for (i(p, k, x), p = p.sibling; p !== null; ) i(p, k, x), p = p.sibling;
          }(e, n, t);
        }
        function Pl(e, t, n) {
          for (var r, i, p = t, k = !1; ; ) {
            ...
            if (p.tag === 5 || p.tag === 6) {
              e: for (var x = e, Z = p, q = n, ge = Z; ; ) if (Cl(x, ge, q), ge.child !== null && ge.tag !== 4) ge.child.return = ge, ge = ge.child;
              else {
                if (ge === Z) break e;
                for (; ge.sibling === null; ) {
              ...
              i ? (x = r, Z = p.stateNode, x.nodeType === 8 ? x.parentNode.removeChild(Z) : x.removeChild(Z)) : r.removeChild(p.stateNode);
            } else if (p.tag === 4) {
              if (p.child !== null) {
              ...
              if (n != null) {
                ...
                if (t.updateQueue = null, p !== null) {
                  for (n[no] = r, e === "input" && r.type === "radio" && r.name != null && Tr(n, r), Qo(e, i), t = Qo(e, r), i = 0; i < p.length; i += 2) {
                    var k = p[i], x = p[i + 1];
                    k === "style" ? xi(n, x) : k === "dangerouslySetInnerHTML" ? qe(n, x) : k === "children" ? st(n, x) : je(n, k, x, t);
                  }
                  switch (e) {
                    case "input":
                      ir(n, r);
        ...
        var Ml, Pc = Math.ceil, la = he.ReactCurrentDispatcher, Il = he.ReactCurrentOwner, po = 0, ca = 3, ua = 4, Qe = 0, _n = null, Ge = null, mn = 0, Ft = po, da = null, kr = 1073741823, fi = 1073741823, fa = null, pi = 0, pa = !1, cs = 0, Me = null, ha = !1, us = null, qr = null, ma = !1, hi = null, mi = 90, ho = null, gi = 0, ds = null, ga = 0;
        function nr() {
        ...
        function xn(e) {
          if (e.lastExpiredTime !== 0) e.callbackExpirationTime = 1073741823, e.callbackPriority = 99, e.callbackNode = Hs(fs.bind(null, e));
          else {
            ...
            if (t === 0) n !== null && (e.callbackNode = null, e.callbackExpirationTime = 0, e.callbackPriority = 90);
              ...
              e.callbackExpirationTime = t, e.callbackPriority = r, t = t === 1073741823 ? Hs(fs.bind(null, e)) : Ws(r, jl.bind(null, e), { timeout: 10 * (1073741821 - t) - jn() }), e.callbackNode = t;
            }
          }
        }
        function jl(e, t) {
            ...
            if (Vo(), e === _n && n === mn || go(e, n), Ge !== null) {
              ...
              if (Ge === null) switch (i = e.finishedWork = e.current.alternate, e.finishedExpirationTime = n, r = Ft, _n = null, r) {
                ...
                case ua:
                  ...
                  if (fi !== 1073741823 ? r = 10 * (1073741821 - fi) - jn() : kr === 1073741823 ? r = 0 : (r = 10 * (1073741821 - kr) - 5e3, 0 > (r = (i = jn()) - r) && (r = 0), (n = 10 * (1073741821 - n) - i) < (r = (120 > r ? 120 : 480 > r ? 480 : 1080 > r ? 1080 : 1920 > r ? 1920 : 3e3 > r ? 3e3 : 4320 > r ? 4320 : 1960 * Pc(r / 1960)) - r) && (r = n)), 10 < r) {
        ...
        function go(e, t) {
          ...
          _n = e, Ge = vo(e.current, null), mn = t, Ft = po, da = null, fi = kr = 1073741823, fa = null, pi = 0, pa = !1;
        }
        function Ul(e, t) {
          for (; ; ) {
            try {
              ...
              e: {
                var i = e, p = Ge.return, k = Ge, x = t;
                if (t = mn, k.effectTag |= 2048, k.firstEffect = k.lastEffect = null, x !== null && typeof x == "object" && typeof x.then == "function") {
                  var Z = x;
                  if (!(2 & k.mode)) {
                    var q = k.alternate;
                  ...
                  do {
                    ...
                    if (He) {
                      ...
                      x = void 0, k = t;
                      var ue = i.pingCache;
                      if (ue === null ? (ue = i.pingCache = new Nc(), x = /* @__PURE__ */ new Set(), ue.set(Z, x)) : (x = ue.get(Z)) === void 0 && (x = /* @__PURE__ */ new Set(), ue.set(Z, x)), !x.has(k)) {
                        x.add(k);
                  ...
                  x = Error((Yt(k.type) || "A React component") + ` suspended while rendering, but no fallback UI was specified.

Add a <Suspense fallback=...> component higher in the tree to provide a loading indicator or placeholder to display.` + xr(k));
                }
                Ft !== 5 && (Ft = 2), x = as(x, k), De = p;
                do {
                  switch (De.tag) {
                    case 3:
                      Z = x, De.effectTag |= 4096, De.expirationTime = t, Ys(De, Rl(De, Z, t));
                      break e;
                    case 1:
                      Z = x;
        ...
        function Bl(e, t) {
          e < kr && 2 < e && (kr = e), t !== null && e < fi && 2 < e && (fi = e, fa = t);
        }
        function va(e) {
          e > pi && (pi = e);
        }
        function Dc() {
          for (; Ge !== null; ) Ge = Wl(Ge);
        }
        function Rc() {
          for (; Ge !== null && !yc(); ) Ge = Wl(Ge);
        }
        function Wl(e) {
          var t = Ml(e.alternate, e, mn);
          return e.memoizedProps = e.pendingProps, t === null && (t = Hl(e)), Il.current = null, t;
        }
        function Hl(e) {
          Ge = e;
          do {
        ...
        function Ac(e, t) {
          ...
          if (e.firstPendingTime = i, r <= e.lastSuspendedTime ? e.firstSuspendedTime = e.lastSuspendedTime = e.nextKnownPendingLevel = 0 : r <= e.firstSuspendedTime && (e.firstSuspendedTime = r - 1), r <= e.lastPingedTime && (e.lastPingedTime = 0), r <= e.lastExpiredTime && (e.lastExpiredTime = 0), e === _n && (Ge = _n = null, mn = 0), 1 < n.effectTag ? n.lastEffect !== null ? (n.lastEffect.nextEffect = n, i = n.firstEffect) : i = n : i = n.firstEffect, i !== null) {
            ...
            var k = Ni();
            if (Xo(k)) {
              if ("selectionStart" in k) var x = { start: k.selectionStart, end: k.selectionEnd };
              else e: {
                var Z = (x = (x = k.ownerDocument) && x.defaultView || window).getSelection && x.getSelection();
                if (Z && Z.rangeCount !== 0) {
                  x = Z.anchorNode;
                  ...
                  var De = 0, He = -1, ot = -1, Fn = 0, ln = 0, re = k, ee = null;
                  t: for (; ; ) {
                    for (var ue; re !== x || q !== 0 && re.nodeType !== 3 || (He = De + q), re !== ge || Z !== 0 && re.nodeType !== 3 || (ot = De + Z), re.nodeType === 3 && (De += re.nodeValue.length), (ue = re.firstChild) !== null; ) ee = re, re = ue;
                    for (; ; ) {
                      if (re === k) break t;
                      if (ee === x && ++Fn === q && (He = De), ee === ge && ++ln === Z && (ot = De), (ue = re.nextSibling) !== null) break;
                      ee = (re = ee).parentNode;
                    }
                    re = ue;
                  }
            ...
            Jo = { activeElementDetached: null, focusedElem: k, selectionRange: x }, Co = !1, Me = i;
            do
              try {
                Mc();
              } catch (Ze) {
            ...
            while (Me !== null);
            if (Oe = Jo, _e = Ni(), ve = Oe.focusedElem, x = Oe.selectionRange, _e !== ve && ve && ve.ownerDocument && function Ze(Bt, wr) {
          ...
          if ((t = e.firstPendingTime) === 0 && (qr = null), t === 1073741823 ? e === ds ? gi++ : (gi = 0, ds = e) : gi = 0, typeof hs == "function" && hs(n.stateNode, r), xn(e), ha) throw ha = !1, e = us, us = null, e;
          return 8 & Qe || Jn(), null;
        }
        function Mc() {
          for (; Me !== null; ) {
            var e = Me.effectTag;
            256 & e && Tc(Me.alternate, Me), !(512 & e) || ma || (ma = !0, Ws(97, function() {
              return Vo(), null;
            })), Me = Me.nextEffect;
          }
        }
        ...
        function Vl(e, t, n) {
          Vr(e, t = Rl(e, t = as(n, t), 1073741823)), (e = ba(e, 1073741823)) !== null && xn(e);
        }
        function yo(e, t) {
          if (e.tag === 3) Vl(e, e, t);
            ...
            if (n.tag === 1) {
              ...
              if (typeof n.type.getDerivedStateFromError == "function" || typeof r.componentDidCatch == "function" && (qr === null || !qr.has(r))) {
                Vr(n, e = Al(n, e = as(t, e), 1073741823)), (n = ba(n, 1073741823)) !== null && xn(n);
                break;
              }
            }
            n = n.return;
        ...
        Ml = function(e, t, n) {
          ...
          switch (t.expirationTime = 0, t.tag) {
            ...
            case 3:
              ...
              if (r = t.pendingProps, i = (i = t.memoizedState) !== null ? i.element : null, Fa(e, t), ai(t, r, null, n), (r = t.memoizedState.element) === i) ts(), t = vr(e, t, n);
              else {
              ...
              return t;
            case 5:
              return Js(t), e === null && es(t), r = t.type, i = t.pendingProps, p = e !== null ? e.memoizedProps : null, k = i.children, ei(r, i) ? k = null : p !== null && ei(r, p) && (t.effectTag |= 16), hl(e, t), 4 & t.mode && n !== 1 && i.hidden ? (t.expirationTime = t.childExpirationTime = 1, t = null) : (Un(e, t, k, n), t = t.child), t;
            case 6:
            ...
            case 10:
              e: {
                ...
                if (St($i, x._currentValue), x._currentValue = p, k !== null) if (x = k.value, (p = mr(x, p) ? 0 : 0 | (typeof r._calculateChangedBits == "function" ? r._calculateChangedBits(x, p) : 1073741823)) === 0) {
                  ...
                  if (Z !== null) {
                    ...
                    for (var q = Z.firstContext; q !== null; ) {
                      if (q.context === r && q.observedBits & p) {
                        x.tag === 1 && ((q = Hr(n, null)).tag = 2, Vr(x, q)), x.expirationTime < n && (x.expirationTime = n), (q = x.alternate) !== null && q.expirationTime < n && (q.expirationTime = n), $s(x.return, n), Z.expirationTime < n && (Z.expirationTime = n);
                        break;
                      }
                      q = q.next;
                    }
                  } else k = x.tag === 10 && x.type === t.type ? null : x.child;
        ...
        function wa(e, t, n, r) {
          var i = t.current, p = nr(), k = si.suspense;
          p = mo(p, i, k);
          e: if (n) {
            t: {
          ...
          return t.context === null ? t.context = n : t.pendingContext = n, (t = Hr(p, k)).payload = { element: e }, (r = r === void 0 ? null : r) !== null && (t.callback = r), Vr(i, t), Kr(i, p), p;
        }
        function ks(e) {
        ...
        var Ql, _s, Bc = { Events: [oo, Gn, ni, le, j, jr, function(e) {
          qn(e, Ra);
        ...
        if (typeof window > "u" || typeof MessageChannel != "function") {
          ...
          var P = window.performance, G = window.Date, K = window.setTimeout, z = window.clearTimeout;
          if (typeof console < "u") {
          ...
          j.port1.onmessage = function() {
            if (W !== null) {
              ...
              Q = Y + oe;
              try {
                W(!0, Y) ? A.postMessage(null) : (M = !1, W = null);
              } catch (me) {
                throw A.postMessage(null), me;
              }
            } else M = !1;
          }, c = function(Y) {
            W = Y, M || (M = !0, A.postMessage(null));
          }, o = function(Y, me) {
            R = K(function() {
              Y(a.unstable_now());
            }, me);
        ...
        a.unstable_IdlePriority = 5, a.unstable_ImmediatePriority = 1, a.unstable_LowPriority = 4, a.unstable_NormalPriority = 3, a.unstable_Profiling = null, a.unstable_UserBlockingPriority = 2, a.unstable_cancelCallback = function(Y) {
        ...
        }, a.unstable_requestPaint = X, a.unstable_runWithPriority = function(Y, me) {
          switch (Y) {
            case 1:
            case 2:
            case 3:
          ...
          return Y = { id: de++, callback: me, priorityLevel: Y, startTime: w, expirationTime: l = w + l, sortIndex: -1 }, w > f ? (Y.sortIndex = w, se(J, Y), le(ye) === null && Y === le(J) && (we ? S() : we = !0, o(xe, w - f))) : (Y.sortIndex = l, se(ye, Y), Te || be || (Te = !0, c(ze))), Y;
        ...
        const c = u(13), o = u(26), S = u(17), m = { string: c.quoteString, number: (g) => Object.is(g, -0) ? "-0" : String(g), boolean: String, symbol: (g, y, v) => {
          const C = Symbol.keyFor(g);
          return C !== void 0 ? `Symbol.for(${v(C)})` : `Symbol(${v(g.description)})`;
        }, bigint: (g, y, v) => `BigInt(${v(String(g))})`, undefined: String, object: o.objectToString, function: S.functionToString };
        a.toString = (g, y, v, C) => g === null ? "null" : m[typeof g](g, y, v, C);
      }, function(b, a, u) {
        (function(c, o) {
          Object.defineProperty(a, "__esModule", { value: !0 }), a.objectToString = void 0;
          const S = u(13), m = u(17), g = u(31);
          a.objectToString = (C, O, P, G) => {
            ...
            return K ? K(C, O, P, G) : void 0;
          };
          const y = (C, O, P) => `Function(${P("return this")})()`, v = { "[object Array]": g.arrayToString, "[object Object]": (C, O, P, G) => {
            const K = O ? `
` : "", z = O ? " " : "", B = Object.keys(C).reduce(function(N, M) {
              const W = C[M], R = P(W, M);
              if (R === void 0) return N;
              const oe = R.split(`
`).join(`
` + O);
              return m.USED_METHOD_KEY.has(W) ? (N.push(`${O}${oe}`), N) : (N.push(`${O}${S.quoteKey(M, P)}:${z}${oe}`), N);
            }, []).join("," + K);
            return B === "" ? "{}" : `{${K}${B}${K}}`;
        ...
        (function(c) {
          ...
          function v(l, f, w) {
            if (!(v.TYPED_ARRAY_SUPPORT || this instanceof v)) return new v(l, f, w);
            if (typeof l == "number") {
          ...
          function P(l, f) {
            if (O(f), l = y(l, f < 0 ? 0 : 0 | K(f)), !v.TYPED_ARRAY_SUPPORT) for (var w = 0; w < f; ++w) l[w] = 0;
            return l;
          }
          function G(l, f) {
          ...
          function M(l, f, w, U, F) {
            ...
            if (typeof f == "string" && (f = v.from(f, U)), v.isBuffer(f)) return f.length === 0 ? -1 : W(l, f, w, U, F);
            if (typeof f == "number") return f &= 255, v.TYPED_ARRAY_SUPPORT && typeof Uint8Array.prototype.indexOf == "function" ? F ? Uint8Array.prototype.indexOf.call(l, f, w) : Uint8Array.prototype.lastIndexOf.call(l, f, w) : W(l, [f], w, U, F);
            throw new TypeError("val must be string, number or Buffer");
          }
          function W(l, f, w, U, F) {
            ...
            if (F) {
              var Ve = -1;
              for (H = w; H < je; H++) if (Xe(l, H) === Xe(f, Ve === -1 ? 0 : H - Ve)) {
                if (Ve === -1 && (Ve = H), H - Ve + 1 === Re) return Ve * he;
              } else Ve !== -1 && (H -= H - Ve), Ve = -1;
            } else for (w + Re > je && (w = je - Re), H = w; H >= 0; H--) {
              for (var At = !0, kt = 0; kt < Re; kt++) if (Xe(l, H + kt) !== Xe(f, kt)) {
                At = !1;
                break;
              }
              if (At) return H;
          ...
          function se(l, f, w, U) {
            return me(function(F, H) {
              for (var he, je, Re, Xe = [], Ve = 0; Ve < F.length && !((H -= 2) < 0); ++Ve) he = F.charCodeAt(Ve), je = he >> 8, Re = he % 256, Xe.push(Re), Xe.push(je);
              return Xe;
            }(f, l.length - w), l, w, U);
          }
          function le(l, f, w) {
          ...
          function te(l, f, w) {
            ...
            for (var U = [], F = f; F < w; ) {
              var H, he, je, Re, Xe = l[F], Ve = null, At = Xe > 239 ? 4 : Xe > 223 ? 3 : Xe > 191 ? 2 : 1;
              if (F + At <= w) switch (At) {
                case 1:
                  Xe < 128 && (Ve = Xe);
                  break;
                case 2:
                  (192 & (H = l[F + 1])) == 128 && (Re = (31 & Xe) << 6 | 63 & H) > 127 && (Ve = Re);
                  break;
                case 3:
                  H = l[F + 1], he = l[F + 2], (192 & H) == 128 && (192 & he) == 128 && (Re = (15 & Xe) << 12 | (63 & H) << 6 | 63 & he) > 2047 && (Re < 55296 || Re > 57343) && (Ve = Re);
                  break;
                case 4:
                  H = l[F + 1], he = l[F + 2], je = l[F + 3], (192 & H) == 128 && (192 & he) == 128 && (192 & je) == 128 && (Re = (15 & Xe) << 18 | (63 & H) << 12 | (63 & he) << 6 | 63 & je) > 65535 && Re < 1114112 && (Ve = Re);
              }
              Ve === null ? (Ve = 65533, At = 1) : Ve > 65535 && (Ve -= 65536, U.push(Ve >>> 10 & 1023 | 55296), Ve = 56320 | 1023 & Ve), U.push(Ve), F += At;
            }
            return function(kt) {
              var Jt = kt.length;
          ...
          a.Buffer = v, a.SlowBuffer = function(l) {
            return +l != l && (l = 0), v.alloc(+l);
          }, a.INSPECT_MAX_BYTES = 50, v.TYPED_ARRAY_SUPPORT = c.TYPED_ARRAY_SUPPORT !== void 0 ? c.TYPED_ARRAY_SUPPORT : function() {
            try {
          ...
          }(), a.kMaxLength = g(), v.poolSize = 8192, v._augment = function(l) {
            return l.__proto__ = v.prototype, l;
          }, v.from = function(l, f, w) {
            return C(null, l, f, w);
          }, v.TYPED_ARRAY_SUPPORT && (v.prototype.__proto__ = Uint8Array.prototype, v.__proto__ = Uint8Array, typeof Symbol < "u" && Symbol.species && v[Symbol.species] === v && Object.defineProperty(v, Symbol.species, { value: null, configurable: !0 })), v.alloc = function(l, f, w) {
            return function(U, F, H, he) {
              return O(F), F <= 0 ? y(U, F) : H !== void 0 ? typeof he == "string" ? y(U, F).fill(H, he) : y(U, F).fill(H) : y(U, F);
            }(null, l, f, w);
            ...
            if (l === f) return 0;
            for (var w = l.length, U = f.length, F = 0, H = Math.min(w, U); F < H; ++F) if (l[F] !== f[F]) {
              w = l[F], U = f[F];
              break;
            }
            ...
            return U;
          }, v.byteLength = z, v.prototype._isBuffer = !0, v.prototype.swap16 = function() {
            var l = this.length;
          ...
          }, v.prototype.compare = function(l, f, w, U, F) {
            if (!v.isBuffer(l)) throw new TypeError("Argument must be a Buffer");
            ...
            if (f >= w) return 1;
            if (this === l) return 0;
            for (var H = (F >>>= 0) - (U >>>= 0), he = (w >>>= 0) - (f >>>= 0), je = Math.min(H, he), Re = this.slice(U, F), Xe = l.slice(f, w), Ve = 0; Ve < je; ++Ve) if (Re[Ve] !== Xe[Ve]) {
              H = Re[Ve], he = Xe[Ve];
              break;
            }
            return H < he ? -1 : he < H ? 1 : 0;
          }, v.prototype.includes = function(l, f, w) {
            return this.indexOf(l, f, w) !== -1;
          }, v.prototype.indexOf = function(l, f, w) {
            return M(this, l, f, w, !0);
          }, v.prototype.lastIndexOf = function(l, f, w) {
            return M(this, l, f, w, !1);
          }, v.prototype.write = function(l, f, w, U) {
          ...
          function J(l, f, w) {
            ...
            for (var F = "", H = f; H < w; ++H) F += Je(l[H]);
            return F;
          }
          function de(l, f, w) {
            for (var U = l.slice(f, w), F = "", H = 0; H < U.length; H += 2) F += String.fromCharCode(U[H] + 256 * U[H + 1]);
            return F;
          }
          function D(l, f, w) {
          ...
          function be(l, f, w, U) {
            f < 0 && (f = 65535 + f + 1);
            for (var F = 0, H = Math.min(l.length - w, 2); F < H; ++F) l[w + F] = (f & 255 << 8 * (U ? F : 1 - F)) >>> 8 * (U ? F : 1 - F);
          }
          function Te(l, f, w, U) {
            f < 0 && (f = 4294967295 + f + 1);
            for (var F = 0, H = Math.min(l.length - w, 4); F < H; ++F) l[w + F] = f >>> 8 * (U ? F : 3 - F) & 255;
          }
          function we(l, f, w, U, F, H) {
            if (w + U > l.length) throw new RangeError("Index out of range");
            if (w < 0) throw new RangeError("Index out of range");
          }
          function Ne(l, f, w, U, F) {
            return F || we(l, 0, w, 4), S.write(l, f, w, U, 23, 4), w + 4;
          }
          function xe(l, f, w, U, F) {
            return F || we(l, 0, w, 8), S.write(l, f, w, U, 52, 8), w + 8;
          }
          v.prototype.slice = function(l, f) {
            var w, U = this.length;
            if ((l = ~~l) < 0 ? (l += U) < 0 && (l = 0) : l > U && (l = U), (f = f === void 0 ? U : ~~f) < 0 ? (f += U) < 0 && (f = 0) : f > U && (f = U), f < l && (f = l), v.TYPED_ARRAY_SUPPORT) (w = this.subarray(l, f)).__proto__ = v.prototype;
            else {
              var F = f - l;
              w = new v(F, void 0);
              for (var H = 0; H < F; ++H) w[H] = this[H + l];
            }
            return w;
          }, v.prototype.readUIntLE = function(l, f, w) {
            l |= 0, f |= 0, w || D(l, f, this.length);
            for (var U = this[l], F = 1, H = 0; ++H < f && (F *= 256); ) U += this[l + H] * F;
            return U;
          }, v.prototype.readUIntBE = function(l, f, w) {
            l |= 0, f |= 0, w || D(l, f, this.length);
          ...
          }, v.prototype.readIntLE = function(l, f, w) {
            l |= 0, f |= 0, w || D(l, f, this.length);
            for (var U = this[l], F = 1, H = 0; ++H < f && (F *= 256); ) U += this[l + H] * F;
            return U >= (F *= 128) && (U -= Math.pow(2, 8 * f)), U;
          }, v.prototype.readIntBE = function(l, f, w) {
            l |= 0, f |= 0, w || D(l, f, this.length);
          ...
          }, v.prototype.writeUIntLE = function(l, f, w, U) {
            l = +l, f |= 0, w |= 0, U || ie(this, l, f, w, Math.pow(2, 8 * w) - 1, 0);
            var F = 1, H = 0;
            for (this[f] = 255 & l; ++H < w && (F *= 256); ) this[f + H] = l / F & 255;
            return f + w;
          }, v.prototype.writeUIntBE = function(l, f, w, U) {
            l = +l, f |= 0, w |= 0, U || ie(this, l, f, w, Math.pow(2, 8 * w) - 1, 0);
            var F = w - 1, H = 1;
            for (this[f + F] = 255 & l; --F >= 0 && (H *= 256); ) this[f + F] = l / H & 255;
            return f + w;
          }, v.prototype.writeUInt8 = function(l, f, w) {
            return l = +l, f |= 0, w || ie(this, l, f, 1, 255, 0), v.TYPED_ARRAY_SUPPORT || (l = Math.floor(l)), this[f] = 255 & l, f + 1;
          }, v.prototype.writeUInt16LE = function(l, f, w) {
            return l = +l, f |= 0, w || ie(this, l, f, 2, 65535, 0), v.TYPED_ARRAY_SUPPORT ? (this[f] = 255 & l, this[f + 1] = l >>> 8) : be(this, l, f, !0), f + 2;
          }, v.prototype.writeUInt16BE = function(l, f, w) {
            return l = +l, f |= 0, w || ie(this, l, f, 2, 65535, 0), v.TYPED_ARRAY_SUPPORT ? (this[f] = l >>> 8, this[f + 1] = 255 & l) : be(this, l, f, !1), f + 2;
          }, v.prototype.writeUInt32LE = function(l, f, w) {
            return l = +l, f |= 0, w || ie(this, l, f, 4, 4294967295, 0), v.TYPED_ARRAY_SUPPORT ? (this[f + 3] = l >>> 24, this[f + 2] = l >>> 16, this[f + 1] = l >>> 8, this[f] = 255 & l) : Te(this, l, f, !0), f + 4;
          }, v.prototype.writeUInt32BE = function(l, f, w) {
            return l = +l, f |= 0, w || ie(this, l, f, 4, 4294967295, 0), v.TYPED_ARRAY_SUPPORT ? (this[f] = l >>> 24, this[f + 1] = l >>> 16, this[f + 2] = l >>> 8, this[f + 3] = 255 & l) : Te(this, l, f, !1), f + 4;
          }, v.prototype.writeIntLE = function(l, f, w, U) {
            if (l = +l, f |= 0, !U) {
              var F = Math.pow(2, 8 * w - 1);
              ie(this, l, f, w, F - 1, -F);
            }
            var H = 0, he = 1, je = 0;
            for (this[f] = 255 & l; ++H < w && (he *= 256); ) l < 0 && je === 0 && this[f + H - 1] !== 0 && (je = 1), this[f + H] = (l / he >> 0) - je & 255;
            return f + w;
          }, v.prototype.writeIntBE = function(l, f, w, U) {
            if (l = +l, f |= 0, !U) {
              var F = Math.pow(2, 8 * w - 1);
              ie(this, l, f, w, F - 1, -F);
            }
            ...
            return f + w;
          }, v.prototype.writeInt8 = function(l, f, w) {
            return l = +l, f |= 0, w || ie(this, l, f, 1, 127, -128), v.TYPED_ARRAY_SUPPORT || (l = Math.floor(l)), l < 0 && (l = 255 + l + 1), this[f] = 255 & l, f + 1;
          }, v.prototype.writeInt16LE = function(l, f, w) {
            return l = +l, f |= 0, w || ie(this, l, f, 2, 32767, -32768), v.TYPED_ARRAY_SUPPORT ? (this[f] = 255 & l, this[f + 1] = l >>> 8) : be(this, l, f, !0), f + 2;
          }, v.prototype.writeInt16BE = function(l, f, w) {
            return l = +l, f |= 0, w || ie(this, l, f, 2, 32767, -32768), v.TYPED_ARRAY_SUPPORT ? (this[f] = l >>> 8, this[f + 1] = 255 & l) : be(this, l, f, !1), f + 2;
          }, v.prototype.writeInt32LE = function(l, f, w) {
            return l = +l, f |= 0, w || ie(this, l, f, 4, 2147483647, -2147483648), v.TYPED_ARRAY_SUPPORT ? (this[f] = 255 & l, this[f + 1] = l >>> 8, this[f + 2] = l >>> 16, this[f + 3] = l >>> 24) : Te(this, l, f, !0), f + 4;
          }, v.prototype.writeInt32BE = function(l, f, w) {
            return l = +l, f |= 0, w || ie(this, l, f, 4, 2147483647, -2147483648), l < 0 && (l = 4294967295 + l + 1), v.TYPED_ARRAY_SUPPORT ? (this[f] = l >>> 24, this[f + 1] = l >>> 16, this[f + 2] = l >>> 8, this[f + 3] = 255 & l) : Te(this, l, f, !1), f + 4;
          }, v.prototype.writeFloatLE = function(l, f, w) {
            return Ne(this, l, f, !0, w);
          }, v.prototype.writeFloatBE = function(l, f, w) {
            return Ne(this, l, f, !1, w);
          }, v.prototype.writeDoubleLE = function(l, f, w) {
            return xe(this, l, f, !0, w);
          }, v.prototype.writeDoubleBE = function(l, f, w) {
            return xe(this, l, f, !1, w);
          }, v.prototype.copy = function(l, f, w, U) {
            ...
            var F, H = U - w;
            if (this === l && w < f && f < U) for (F = H - 1; F >= 0; --F) l[F + f] = this[F + w];
            else if (H < 1e3 || !v.TYPED_ARRAY_SUPPORT) for (F = 0; F < H; ++F) l[F + f] = this[F + w];
            else Uint8Array.prototype.set.call(l, this.subarray(w, w + H), f);
            return H;
          }, v.prototype.fill = function(l, f, w, U) {
            if (typeof l == "string") {
            ...
            if (w <= f) return this;
            var H;
            if (f >>>= 0, w = w === void 0 ? this.length : w >>> 0, l || (l = 0), typeof l == "number") for (H = f; H < w; ++H) this[H] = l;
            else {
              var he = v.isBuffer(l) ? l : X(new v(l, U).toString()), je = he.length;
              for (H = 0; H < w - f; ++H) this[H + f] = he[H % je];
            }
            return this;
          };
          ...
          function X(l, f) {
            ...
            for (var U = l.length, F = null, H = [], he = 0; he < U; ++he) {
              ...
              if (F = null, w < 128) {
                ...
                if ((f -= 2) < 0) break;
                H.push(w >> 6 | 192, 63 & w | 128);
              } else if (w < 65536) {
                if ((f -= 3) < 0) break;
                H.push(w >> 12 | 224, w >> 6 & 63 | 128, 63 & w | 128);
              } else {
                if (!(w < 1114112)) throw new Error("Invalid code point");
                if ((f -= 4) < 0) break;
                H.push(w >> 18 | 240, w >> 12 & 63 | 128, w >> 6 & 63 | 128, 63 & w | 128);
              }
            }
            return H;
          }
        ...
        a.byteLength = function(O) {
          var P = v(O), G = P[0], K = P[1];
          return 3 * (G + K) / 4 - K;
        }, a.toByteArray = function(O) {
          var P, G, K = v(O), z = K[0], B = K[1], N = new S(function(R, oe, Q) {
            return 3 * (oe + Q) / 4 - Q;
          }(0, z, B)), M = 0, W = B > 0 ? z - 4 : z;
          for (G = 0; G < W; G += 4) P = o[O.charCodeAt(G)] << 18 | o[O.charCodeAt(G + 1)] << 12 | o[O.charCodeAt(G + 2)] << 6 | o[O.charCodeAt(G + 3)], N[M++] = P >> 16 & 255, N[M++] = P >> 8 & 255, N[M++] = 255 & P;
          return B === 2 && (P = o[O.charCodeAt(G)] << 2 | o[O.charCodeAt(G + 1)] >> 4, N[M++] = 255 & P), B === 1 && (P = o[O.charCodeAt(G)] << 10 | o[O.charCodeAt(G + 1)] << 4 | o[O.charCodeAt(G + 2)] >> 2, N[M++] = P >> 8 & 255, N[M++] = 255 & P), N;
        }, a.fromByteArray = function(O) {
          for (var P, G = O.length, K = G % 3, z = [], B = 0, N = G - K; B < N; B += 16383) z.push(C(O, B, B + 16383 > N ? N : B + 16383));
          return K === 1 ? (P = O[G - 1], z.push(c[P >> 2] + c[P << 4 & 63] + "==")) : K === 2 && (P = (O[G - 2] << 8) + O[G - 1], z.push(c[P >> 10] + c[P >> 4 & 63] + c[P << 2 & 63] + "=")), z.join("");
        };
        for (var c = [], o = [], S = typeof Uint8Array < "u" ? Uint8Array : Array, m = "ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/", g = 0, y = m.length; g < y; ++g) c[g] = m[g], o[m.charCodeAt(g)] = g;
        function v(O) {
          var P = O.length;
        ...
        function C(O, P, G) {
          for (var K, z, B = [], N = P; N < G; N += 3) K = (O[N] << 16 & 16711680) + (O[N + 1] << 8 & 65280) + (255 & O[N + 2]), B.push(c[(z = K) >> 18 & 63] + c[z >> 12 & 63] + c[z >> 6 & 63] + c[63 & z]);
          return B.join("");
        }
        o[45] = 62, o[95] = 63;
      }, function(b, a) {
        a.read = function(u, c, o, S, m) {
          var g, y, v = 8 * m - S - 1, C = (1 << v) - 1, O = C >> 1, P = -7, G = o ? m - 1 : 0, K = o ? -1 : 1, z = u[c + G];
          for (G += K, g = z & (1 << -P) - 1, z >>= -P, P += v; P > 0; g = 256 * g + u[c + G], G += K, P -= 8) ;
          for (y = g & (1 << -P) - 1, g >>= -P, P += S; P > 0; y = 256 * y + u[c + G], G += K, P -= 8) ;
          if (g === 0) g = 1 - O;
          else {
            if (g === C) return y ? NaN : 1 / 0 * (z ? -1 : 1);
            y += Math.pow(2, S), g -= O;
          }
          return (z ? -1 : 1) * y * Math.pow(2, g - S);
        }, a.write = function(u, c, o, S, m, g) {
          var y, v, C, O = 8 * g - m - 1, P = (1 << O) - 1, G = P >> 1, K = m === 23 ? Math.pow(2, -24) - Math.pow(2, -77) : 0, z = S ? 0 : g - 1, B = S ? 1 : -1, N = c < 0 || c === 0 && 1 / c < 0 ? 1 : 0;
          for (c = Math.abs(c), isNaN(c) || c === 1 / 0 ? (v = isNaN(c) ? 1 : 0, y = P) : (y = Math.floor(Math.log(c) / Math.LN2), c * (C = Math.pow(2, -y)) < 1 && (y--, C *= 2), (c += y + G >= 1 ? K / C : K * Math.pow(2, 1 - G)) * C >= 2 && (y++, C /= 2), y + G >= P ? (v = 0, y = P) : y + G >= 1 ? (v = (c * C - 1) * Math.pow(2, m), y += G) : (v = c * Math.pow(2, G - 1) * Math.pow(2, m), y = 0)); m >= 8; u[o + z] = 255 & v, z += B, v /= 256, m -= 8) ;
          for (y = y << m | v, O += m; O > 0; u[o + z] = 255 & y, z += B, y /= 256, O -= 8) ;
          u[o + z - B] |= 128 * N;
        };
      }, function(b, a) {
        var u = {}.toString;
        ...
        Object.defineProperty(a, "__esModule", { value: !0 }), a.arrayToString = void 0, a.arrayToString = (c, o, S) => {
          const m = c.map(function(y, v) {
            const C = S(y, v);
...
` : "";
        ...
        Object.defineProperty(a, "__esModule", { value: !0 }), a.matchesSelector = O, a.matchesSelectorAndParentsTo = function(z, B, N) {
          var M = z;
          do {
            if (O(M, B)) return !0;
            if (M === N) return !1;
          ...
          return !1;
        }, a.addEvent = function(z, B, N, M) {
          if (z) {
            var W = y({ capture: !0 }, M);
            z.addEventListener ? z.addEventListener(B, N, W) : z.attachEvent ? z.attachEvent("on" + B, N) : z["on" + B] = N;
          }
        }, a.removeEvent = function(z, B, N, M) {
          if (z) {
            var W = y({ capture: !0 }, M);
            z.removeEventListener ? z.removeEventListener(B, N, W) : z.detachEvent ? z.detachEvent("on" + B, N) : z["on" + B] = null;
          }
          ...
          var M = B === B.ownerDocument.body ? { left: 0, top: 0 } : B.getBoundingClientRect(), W = (z.clientX + B.scrollLeft - M.left) / N, R = (z.clientY + B.scrollTop - M.top) / N;
          return { x: W, y: R };
        }, a.createCSSTransform = function(z, B) {
          var N = P(z, B, "px");
          return v({}, (0, S.browserPrefixToKey)("transform", S.default), N);
...
`, z.getElementsByTagName("head")[0].appendChild(B)), z.body && G(z.body, "react-draggable-transparent-selection");
          }
        ...
        }, a.addClassName = G, a.removeClassName = K;
        var o = u(20), S = function(z) {
          ...
          for (var W in z) if (Object.prototype.hasOwnProperty.call(z, W)) {
            var R = M ? Object.getOwnPropertyDescriptor(z, W) : null;
            R && (R.get || R.set) ? Object.defineProperty(N, W, R) : N[W] = z[W];
          }
        ...
        function y(z) {
          for (var B = 1; B < arguments.length; B++) {
            ...
            B % 2 ? g(Object(N), !0).forEach(function(M) {
              v(z, M, N[M]);
            }) : Object.getOwnPropertyDescriptors ? Object.defineProperties(z, Object.getOwnPropertyDescriptors(N)) : g(Object(N)).forEach(function(M) {
              Object.defineProperty(z, M, Object.getOwnPropertyDescriptor(N, M));
            });
          }
          return z;
        }
        ...
        function P(z, B, N) {
          var M = z.x, W = z.y, R = "translate(".concat(M).concat(N, ",").concat(W).concat(N, ")");
          if (B) {
        ...
        var c, o = u(82), S = ((c = o) && c.__esModule ? c : { default: c }).default, m = S.canUseDOM ? window.HTMLElement : {};
        a.SafeHTMLCollection = S.canUseDOM ? window.HTMLCollection : {}, a.SafeNodeList = S.canUseDOM ? window.NodeList : {}, a.canUseDOM = S.canUseDOM, a.default = m;
      }, function(b, a, u) {
        var c = u(6), o = u(38);
        typeof (o = o.__esModule ? o.default : o) == "string" && (o = [[b.i, o, ""]]);
        var S = { injectType: "singletonStyleTag", attributes: { "data-cke-inspector": !0 }, insert: "head", singleton: !0 };
        ...
        var v = Object.defineProperty, C = Object.getOwnPropertyNames, O = Object.getOwnPropertySymbols, P = Object.getOwnPropertyDescriptor, G = Object.getPrototypeOf, K = Object.prototype;
        b.exports = function z(B, N, M) {
          if (typeof N != "string") {
            if (K) {
              var W = G(N);
              W && W !== K && z(B, W, M);
            ...
            var R = C(N);
            O && (R = R.concat(O(N)));
            for (var oe = y(B), Q = y(N), j = 0; j < R.length; ++j) {
              var A = R[j];
              if (!(S[A] || M && M[A] || Q && Q[A] || oe && oe[A])) {
                var se = P(N, A);
                try {
                  v(B, A, se);
                } catch {
        ...
        Object.defineProperty(a, "__esModule", { value: !0 }), a.getBoundPosition = function(m, g, y) {
          if (!m.props.bounds) return [g, y];
          var v = m.props.bounds;
          v = typeof v == "string" ? v : function(B) {
            return { left: B.left, top: B.top, right: B.right, bottom: B.bottom };
          }(v);
          var C = S(m);
          if (typeof v == "string") {
            var O, P = C.ownerDocument, G = P.defaultView;
            if (!((O = v === "parent" ? C.parentNode : P.querySelector(v)) instanceof G.HTMLElement)) throw new Error('Bounds selector "' + v + '" could not find an element.');
            var K = G.getComputedStyle(C), z = G.getComputedStyle(O);
            v = { left: -C.offsetLeft + (0, c.int)(z.paddingLeft) + (0, c.int)(K.marginLeft), top: -C.offsetTop + (0, c.int)(z.paddingTop) + (0, c.int)(K.marginTop), right: (0, o.innerWidth)(O) - (0, o.outerWidth)(C) - C.offsetLeft + (0, c.int)(z.paddingRight) - (0, c.int)(K.marginRight), bottom: (0, o.innerHeight)(O) - (0, o.outerHeight)(C) - C.offsetTop + (0, c.int)(z.paddingBottom) - (0, c.int)(K.marginBottom) };
          }
          return (0, c.isNum)(v.right) && (g = Math.min(g, v.right)), (0, c.isNum)(v.bottom) && (y = Math.min(y, v.bottom)), (0, c.isNum)(v.left) && (g = Math.max(g, v.left)), (0, c.isNum)(v.top) && (y = Math.max(y, v.top)), [g, y];
        }, a.snapToGrid = function(m, g, y) {
          var v = Math.round(g / m[0]) * m[0], C = Math.round(y / m[1]) * m[1];
          return [v, C];
        }, a.canDragX = function(m) {
          return m.props.axis === "both" || m.props.axis === "x";
        }, a.canDragY = function(m) {
          return m.props.axis === "both" || m.props.axis === "y";
        }, a.getControlPosition = function(m, g, y) {
          var v = typeof g == "number" ? (0, o.getTouch)(m, g) : null;
          if (typeof g == "number" && !v) return null;
          var C = S(y), O = y.props.offsetParent || C.offsetParent || C.ownerDocument.body;
          return (0, o.offsetXYFromParent)(v || m, O, y.props.scale);
        }, a.createCoreData = function(m, g, y) {
          var v = m.state, C = !(0, c.isNum)(v.lastX), O = S(m);
          return C ? { node: O, deltaX: 0, deltaY: 0, lastX: g, lastY: y, x: g, y } : { node: O, deltaX: g - v.lastX, deltaY: y - v.lastY, lastX: v.lastX, lastY: v.lastY, x: g, y };
        ...
        Object.defineProperty(a, "__esModule", { value: !0 }), a.default = function g(y) {
          return [].slice.call(y.querySelectorAll("*"), 0).reduce(function(v, C) {
            return v.concat(C.shadowRoot ? g(C.shadowRoot) : [C]);
          }, []).filter(m);
        };
        ...
        function o(g) {
          ...
          try {
            ...
            return y ? v.getPropertyValue("overflow") !== "visible" || g.scrollWidth <= 0 && g.scrollHeight <= 0 : v.getPropertyValue("display") == "none";
          } catch {
        ...
        function S(g, y) {
          ...
          return (c.test(v) && !g.disabled || v === "a" && g.href || y) && function(C) {
        ...
        Object.defineProperty(a, "__esModule", { value: !0 }), a.resetState = function() {
        ...
        }, a.assertNodeList = y, a.setElement = function(C) {
          var O = C;
          ...
          return g = O || g;
        }, a.validateElement = v, a.hide = function(C) {
          var O = !0, P = !1, G = void 0;
          try {
            for (var K, z = v(C)[Symbol.iterator](); !(O = (K = z.next()).done); O = !0)
        ...
        var c, o = u(81), S = (c = o) && c.__esModule ? c : { default: c }, m = u(36), g = null;
        function y(C, O) {
        ...
        var c = u(52), o = c.default, S = c.DraggableCore;
        b.exports = o, b.exports.default = o, b.exports.DraggableCore = S;
      }, function(b, a, u) {
        var c = u(76), o = { "text/plain": "Text", "text/html": "Url", default: "Text" };
        b.exports = function(S, m) {
          var g, y, v, C, O, P, G = !1;
          m || (m = {}), g = m.debug || !1;
          try {
            if (v = c(), C = document.createRange(), O = document.getSelection(), (P = document.createElement("span")).textContent = S, P.style.all = "unset", P.style.position = "fixed", P.style.top = 0, P.style.clip = "rect(0, 0, 0, 0)", P.style.whiteSpace = "pre", P.style.webkitUserSelect = "text", P.style.MozUserSelect = "text", P.style.msUserSelect = "text", P.style.userSelect = "text", P.addEventListener("copy", function(K) {
              if (K.stopPropagation(), m.format) if (K.preventDefault(), K.clipboardData === void 0) {
                ...
                window.clipboardData.setData(z, S);
              } else K.clipboardData.clearData(), K.clipboardData.setData(m.format, S);
            ...
            try {
              window.clipboardData.setData(m.format || "text", S), m.onCopy && m.onCopy(window.clipboardData), G = !0;
            } catch (z) {
              g && console.error("unable to copy using clipboardData: ", z), g && console.error("falling back to prompt"), y = function(B) {
            ...
            O && (typeof O.removeRange == "function" ? O.removeRange(C) : O.removeAllRanges()), P && document.body.removeChild(P), v();
          }
          return G;
        };
      }, function(b, a, u) {
        Object.defineProperty(a, "__esModule", { value: !0 });
        var c, o = u(77), S = (c = o) && c.__esModule ? c : { default: c };
        a.default = S.default, b.exports = a.default;
      }, function(b, a, u) {
        b.exports = u(50);
      }, function(b, a, u) {
        var c = typeof Symbol == "function" && Symbol.for, o = c ? Symbol.for("react.element") : 60103, S = c ? Symbol.for("react.portal") : 60106, m = c ? Symbol.for("react.fragment") : 60107, g = c ? Symbol.for("react.strict_mode") : 60108, y = c ? Symbol.for("react.profiler") : 60114, v = c ? Symbol.for("react.provider") : 60109, C = c ? Symbol.for("react.context") : 60110, O = c ? Symbol.for("react.async_mode") : 60111, P = c ? Symbol.for("react.concurrent_mode") : 60111, G = c ? Symbol.for("react.forward_ref") : 60112, K = c ? Symbol.for("react.suspense") : 60113, z = c ? Symbol.for("react.suspense_list") : 60120, B = c ? Symbol.for("react.memo") : 60115, N = c ? Symbol.for("react.lazy") : 60116, M = c ? Symbol.for("react.block") : 60121, W = c ? Symbol.for("react.fundamental") : 60117, R = c ? Symbol.for("react.responder") : 60118, oe = c ? Symbol.for("react.scope") : 60119;
        function Q(A) {
        ...
        a.AsyncMode = O, a.ConcurrentMode = P, a.ContextConsumer = C, a.ContextProvider = v, a.Element = o, a.ForwardRef = G, a.Fragment = m, a.Lazy = N, a.Memo = B, a.Portal = S, a.Profiler = y, a.StrictMode = g, a.Suspense = K, a.isAsyncMode = function(A) {
          return j(A) || Q(A) === O;
          ...
          return typeof A == "string" || typeof A == "function" || A === m || A === P || A === y || A === g || A === K || A === z || typeof A == "object" && A !== null && (A.$$typeof === N || A.$$typeof === B || A.$$typeof === v || A.$$typeof === C || A.$$typeof === G || A.$$typeof === W || A.$$typeof === R || A.$$typeof === oe || A.$$typeof === M);
        }, a.typeOf = Q;
      }, function(b, a, u) {
        var c = 60103, o = 60106, S = 60107, m = 60108, g = 60114, y = 60109, v = 60110, C = 60112, O = 60113, P = 60120, G = 60115, K = 60116, z = 60121, B = 60122, N = 60117, M = 60129, W = 60131;
        if (typeof Symbol == "function" && Symbol.for) {
          var R = Symbol.for;
          c = R("react.element"), o = R("react.portal"), S = R("react.fragment"), m = R("react.strict_mode"), g = R("react.profiler"), y = R("react.provider"), v = R("react.context"), C = R("react.forward_ref"), O = R("react.suspense"), P = R("react.suspense_list"), G = R("react.memo"), K = R("react.lazy"), z = R("react.block"), B = R("react.server.block"), N = R("react.fundamental"), M = R("react.debug_trace_mode"), W = R("react.legacy_hidden");
        }
        function oe(D) {
        ...
        var Q = y, j = c, A = C, se = S, le = K, te = G, ce = o, ye = g, J = m, de = O;
        a.ContextConsumer = v, a.ContextProvider = Q, a.Element = j, a.ForwardRef = A, a.Fragment = se, a.Lazy = le, a.Memo = te, a.Portal = ce, a.Profiler = ye, a.StrictMode = J, a.Suspense = de, a.isAsyncMode = function() {
          return !1;
          ...
          return typeof D == "string" || typeof D == "function" || D === S || D === g || D === M || D === m || D === O || D === P || D === W || typeof D == "object" && D !== null && (D.$$typeof === K || D.$$typeof === G || D.$$typeof === y || D.$$typeof === v || D.$$typeof === C || D.$$typeof === N || D.$$typeof === z || D[0] === B);
        }, a.typeOf = oe;
      }, function(b, a, u) {
        ...
        }(u(0)), o = P(u(18)), S = P(u(12)), m = P(u(55)), g = u(32), y = u(40), v = u(20), C = P(u(57)), O = P(u(41));
        function P(J) {
        ...
        function B(J, de) {
          ...
          var D, ie, be = function(we, Ne) {
            if (we == null) return {};
            var xe, ze, Je = {}, X = Object.keys(we);
            for (ze = 0; ze < X.length; ze++) xe = X[ze], Ne.indexOf(xe) >= 0 || (Je[xe] = we[xe]);
            return Je;
          }(J, de);
          if (Object.getOwnPropertySymbols) {
...
In order to be iterable, non-array objects must have a [Symbol.iterator]() method.`);
        ...
        function R(J) {
          for (var de = 1; de < arguments.length; de++) {
            ...
            de % 2 ? W(Object(D), !0).forEach(function(ie) {
              ce(J, ie, D[ie]);
            }) : Object.getOwnPropertyDescriptors ? Object.defineProperties(J, Object.getOwnPropertyDescriptors(D)) : W(Object(D)).forEach(function(ie) {
        ...
        var ye = function(J) {
          ...
          function D(ie) {
            ...
            return function(Te, we) {
              ...
              if ((0, O.default)("Draggable: onDragStart: %j", we), be.props.onStart(Te, (0, y.createDraggableData)(le(be), we)) === !1) return !1;
              be.setState({ dragging: !0, dragged: !0 });
            }), ce(le(be), "onDrag", function(Te, we) {
              if (!be.state.dragging) return !1;
              (0, O.default)("Draggable: onDrag: %j", we);
              var Ne = (0, y.createDraggableData)(le(be), we), xe = { x: Ne.x, y: Ne.y };
              if (be.props.bounds) {
                var ze = xe.x, Je = xe.y;
                xe.x += be.state.slackX, xe.y += be.state.slackY;
                var X = N((0, y.getBoundPosition)(le(be), xe.x, xe.y), 2), Y = X[0], me = X[1];
              ...
              if (!be.state.dragging || be.props.onStop(Te, (0, y.createDraggableData)(le(be), we)) === !1) return !1;
              (0, O.default)("Draggable: onDragStop: %j", we);
          ...
          return Q(D, null, [{ key: "getDerivedStateFromProps", value: function(ie, be) {
            ...
            return !Te || we && Te.x === we.x && Te.y === we.y ? null : ((0, O.default)("Draggable: getDerivedStateFromProps %j", { position: Te, prevPropsPosition: we }), { x: Te.x, y: Te.y, prevPropsPosition: R({}, Te) });
            ...
            this.state.isElementSVG ? l = (0, g.createSVGTransform)(U, X) : me = (0, g.createCSSTransform)(U, X);
        ...
        S.resetWarningCache = o, b.exports = function() {
          function m(v, C, O, P, G, K) {
            if (K !== c) {
          ...
          function S() {
            for (var m = [], g = 0; g < arguments.length; g++) {
              ...
              if (y) {
                ...
                } else if (v === "object") if (y.toString === Object.prototype.toString) for (var O in y) o.call(y, O) && y[O] && m.push(O);
                else m.push(y.toString());
              }
            }
            return m.join(" ");
          }
          b.exports ? (S.default = S, b.exports = S) : (c = (function() {
            return S;
          }).apply(a, [])) === void 0 || (b.exports = c);
        })();
      }, function(b, a, u) {
        Object.defineProperty(a, "__esModule", { value: !0 }), a.getPrefix = o, a.browserPrefixToKey = S, a.browserPrefixToStyle = function(g, y) {
        ...
        function o() {
          ...
          if (g in y) return "";
          for (var v = 0; v < c.length; v++) if (S(g, c[v]) in y) return c[v];
          return "";
        }
        function S(g, y) {
          return y ? "".concat(y).concat(function(v) {
            for (var C = "", O = !0, P = 0; P < v.length; P++) O ? (C += v[P].toUpperCase(), O = !1) : v[P] === "-" ? O = !0 : C += v[P];
            return C;
          }(g)) : g;
        }
        var m = o();
        ...
        }(u(0)), o = C(u(18)), S = C(u(12)), m = u(32), g = u(40), y = u(20), v = C(u(41));
        function C(te) {
...
In order to be iterable, non-array objects must have a [Symbol.iterator]() method.`);
          ...
          function de() {
            ...
            return Q(R(D = J.call.apply(J, [this].concat(be))), "state", { dragging: !1, lastX: NaN, lastY: NaN, touchIdentifier: null }), Q(R(D), "mounted", !1), Q(R(D), "handleDragStart", function(we) {
              ...
              if (!(D.props.disabled || !(we.target instanceof xe.defaultView.Node) || D.props.handle && !(0, m.matchesSelectorAndParentsTo)(we.target, D.props.handle, Ne) || D.props.cancel && (0, m.matchesSelectorAndParentsTo)(we.target, D.props.cancel, Ne))) {
                ...
                if (Je != null) {
                  var X = Je.x, Y = Je.y, me = (0, g.createCoreData)(R(D), X, Y);
                  (0, v.default)("DraggableCore: handleDragStart: %j", me), (0, v.default)("calling", D.props.onStart), D.props.onStart(we, me) !== !1 && D.mounted !== !1 && (D.props.enableUserSelectHack && (0, m.addUserSelectStyles)(xe), D.setState({ dragging: !0, lastX: X, lastY: Y }), (0, m.addEvent)(xe, se.move, D.handleDrag), (0, m.addEvent)(xe, se.stop, D.handleDragStop));
                }
              }
              ...
              if (Ne != null) {
                ...
                if (Array.isArray(D.props.grid)) {
                  var Je = xe - D.state.lastX, X = ze - D.state.lastY, Y = G((0, g.snapToGrid)(D.props.grid, Je, X), 2);
                  if (Je = Y[0], X = Y[1], !Je && !X) return;
                  xe = D.state.lastX + Je, ze = D.state.lastY + X;
                }
                var me = (0, g.createCoreData)(R(D), xe, ze);
                if ((0, v.default)("DraggableCore: handleDrag: %j", me), D.props.onDrag(we, me) !== !1 && D.mounted !== !1) D.setState({ lastX: xe, lastY: ze });
                else try {
              ...
              if (D.state.dragging) {
                ...
                if (Ne != null) {
                  ...
                  var X = D.findDOMNode();
                  X && D.props.enableUserSelectHack && (0, m.removeUserSelectStyles)(X.ownerDocument), (0, v.default)("DraggableCore: handleDragStop: %j", Je), D.setState({ dragging: !1, lastX: NaN, lastY: NaN }), X && ((0, v.default)("DraggableCore: Removing handlers"), (0, m.removeEvent)(X.ownerDocument, se.move, D.handleDrag), (0, m.removeEvent)(X.ownerDocument, se.stop, D.handleDragStop));
                }
              }
        ...
        b.exports = function() {
          ...
          for (var c = document.activeElement, o = [], S = 0; S < u.rangeCount; S++) o.push(u.getRangeAt(S));
        ...
        var N = a.portalClassName = "ReactModalPortal", M = a.bodyOpenClassName = "ReactModal__Body--open", W = O.canUseDOM && g.default.createPortal !== void 0, R = function(A) {
          return document.createElement(A);
        }, oe = function() {
          return W ? g.default.createPortal : g.default.unstable_renderSubtreeIntoContainer;
        };
        function Q(A) {
          return A();
        }
        var j = function(A) {
          function se() {
            ...
            return te = ce = B(this, (le = se.__proto__ || Object.getPrototypeOf(se)).call.apply(le, [this].concat(J))), ce.removePortal = function() {
              !W && g.default.unmountComponentAtNode(ce.node);
              ...
              var ie = oe()(ce, m.default.createElement(v.default, c({ defaultStyles: se.defaultStyles }, D)), ce.node);
              ce.portalRef(ie);
            }, B(ce, te);
          }
          return function(le, te) {
            ...
            O.canUseDOM && (W || (this.node = R("div")), this.node.className = this.props.portalClassName, Q(this.props.parentSelector).appendChild(this.node), !W && this.renderPortal(this.props));
            ...
            if (O.canUseDOM) {
              ...
              ie !== D && (D.removeChild(this.node), ie.appendChild(this.node)), (le.isOpen || J) && !W && this.renderPortal(this.props);
            }
          } }, { key: "componentWillUnmount", value: function() {
        ...
        }(), m = u(0), g = B(u(18)), y = z(u(79)), v = B(u(80)), C = z(u(43)), O = z(u(83)), P = u(36), G = B(P), K = B(u(44));
        function z(R) {
        ...
        u(84);
        var N = { overlay: "ReactModal__Overlay", content: "ReactModal__Content" }, M = 0, W = function(R) {
          function oe(Q) {
            (function(A, se) {
              if (!(A instanceof se)) throw new TypeError("Cannot call a class as a function");
            })(this, oe);
            ...
            return j.setOverlayRef = function(A) {
              ...
              ce && O.remove(document.body, ce), te && O.remove(document.getElementsByTagName("html")[0], te), le && M > 0 && (M -= 1) === 0 && C.show(se), j.props.shouldFocusAfterRender && (j.props.shouldReturnFocusAfterClose ? (y.returnFocus(j.props.preventScroll), y.teardownScopedFocus()) : y.popWithoutFocus()), j.props.onAfterClose && j.props.onAfterClose(), K.default.deregister(j);
            }, j.open = function() {
              j.beforeOpen(), j.state.afterOpen && j.state.beforeClose ? (clearTimeout(j.closeTimer), j.setState({ beforeClose: !1 })) : (j.props.shouldFocusAfterRender && (y.setupScopedFocus(j.node), y.markForFocusLater()), j.setState({ isOpen: !0 }, function() {
              ...
              A.keyCode === 9 && (0, v.default)(j.content, A), j.props.shouldCloseOnEsc && A.keyCode === 27 && (A.stopPropagation(), j.requestClose(A));
          ...
          return function(Q, j) {
            ...
            le && O.add(document.body, le), se && O.add(document.getElementsByTagName("html")[0], se), A && (M += 1, C.hide(j)), K.default.register(this);
          } }, { key: "render", value: function() {
        ...
        W.defaultProps = { style: { overlay: {}, content: {} }, defaultStyles: {} }, W.propTypes = { isOpen: g.default.bool.isRequired, defaultStyles: g.default.shape({ content: g.default.object, overlay: g.default.object }), style: g.default.shape({ content: g.default.object, overlay: g.default.object }), className: g.default.oneOfType([g.default.string, g.default.object]), overlayClassName: g.default.oneOfType([g.default.string, g.default.object]), bodyOpenClassName: g.default.string, htmlOpenClassName: g.default.string, ariaHideApp: g.default.bool, appElement: g.default.oneOfType([g.default.instanceOf(G.default), g.default.instanceOf(P.SafeHTMLCollection), g.default.instanceOf(P.SafeNodeList), g.default.arrayOf(g.default.instanceOf(G.default))]), onAfterOpen: g.default.func, onAfterClose: g.default.func, onRequestClose: g.default.func, closeTimeoutMS: g.default.number, shouldFocusAfterRender: g.default.bool, shouldCloseOnOverlayClick: g.default.bool, shouldReturnFocusAfterClose: g.default.bool, preventScroll: g.default.bool, role: g.default.string, contentLabel: g.default.string, aria: g.default.object, data: g.default.object, children: g.default.node, shouldCloseOnEsc: g.default.bool, overlayRef: g.default.func, contentRef: g.default.func, id: g.default.string, overlayElement: g.default.func, contentElement: g.default.func, testId: g.default.string }, a.default = W, b.exports = a.default;
      }, function(b, a, u) {
        Object.defineProperty(a, "__esModule", { value: !0 }), a.resetState = function() {
          m = [];
        }, a.log = function() {
        }, a.handleBlur = v, a.handleFocus = C, a.markForFocusLater = function() {
          ...
          m.length > 0 && m.pop();
        }, a.setupScopedFocus = function(O) {
          g = O, window.addEventListener ? (window.addEventListener("blur", v, !1), document.addEventListener("focus", C, !0)) : (window.attachEvent("onBlur", v), document.attachEvent("onFocus", C));
        }, a.teardownScopedFocus = function() {
          g = null, window.addEventListener ? (window.removeEventListener("blur", v), document.removeEventListener("focus", C)) : (window.detachEvent("onBlur", v), document.detachEvent("onFocus", C));
        };
        var c, o = u(42), S = (c = o) && c.__esModule ? c : { default: c }, m = [], g = null, y = !1;
        function v() {
          y = !0;
        }
        function C() {
        ...
        Object.defineProperty(a, "__esModule", { value: !0 }), a.default = function(m, g) {
          ...
          var v = void 0, C = g.shiftKey, O = y[0], P = y[y.length - 1], G = function B() {
          ...
          if (P !== G || C || (v = O), O === G && C && (v = P), v) return g.preventDefault(), void v.focus();
          var K = /(\bChrome\b|\bSafari\b)\//.exec(navigator.userAgent);
          if (!(K == null || K[1] == "Chrome" || /\biPod\b|\biPad\b/g.exec(navigator.userAgent) != null)) {
            var z = y.indexOf(G);
            if (z > -1 && (z += C ? -1 : 1), (v = y[z]) === void 0) return g.preventDefault(), void (v = C ? P : O).focus();
            g.preventDefault(), v.focus();
          }
        };
        var c, o = u(42), S = (c = o) && c.__esModule ? c : { default: c };
        b.exports = a.default;
      }, function(b, a, u) {
        var c = function() {
        };
        ...
        Object.defineProperty(a, "__esModule", { value: !0 }), a.resetState = function() {
          ...
          for (var g in c) S(m, c[g]);
          var y = document.body;
          for (var v in o) S(y, o[v]);
          c = {}, o = {};
        }, a.log = function() {
        };
        var c = {}, o = {};
        ...
        a.add = function(m, g) {
          return y = m.classList, v = m.nodeName.toLowerCase() == "html" ? c : o, void g.split(" ").forEach(function(C) {
            (function(O, P) {
              O[P] || (O[P] = 0), O[P] += 1;
            })(v, C), y.add(C);
          });
        ...
        function o(g) {
          this.setState((function(y) {
            var v = this.constructor.getDerivedStateFromProps(g, y);
            return v ?? null;
          }).bind(this));
        }
        function S(g, y) {
          try {
            ...
            this.props = g, this.state = y, this.__reactInternalSnapshotFlag = !0, this.__reactInternalSnapshot = this.getSnapshotBeforeUpdate(v, C);
          } finally {
...
https://fb.me/react-async-component-lifecycle-hooks`);
          ...
          if (typeof g.getDerivedStateFromProps == "function" && (y.componentWillMount = c, y.componentWillReceiveProps = o), typeof y.getSnapshotBeforeUpdate == "function") {
            ...
            y.componentDidUpdate = function(z, B, N) {
        ...
        u.r(a), u.d(a, "polyfill", function() {
          return m;
        }), c.__suppressDeprecationWarning = !0, o.__suppressDeprecationWarning = !0, S.__suppressDeprecationWarning = !0;
      }, function(b, a, u) {
        var c = u(6), o = u(87);
        typeof (o = o.__esModule ? o.default : o) == "string" && (o = [[b.i, o, ""]]);
        var S = { injectType: "singletonStyleTag", attributes: { "data-cke-inspector": !0 }, insert: "head", singleton: !0 };
        ...
        function P(E, s, d) {
          ...
          return We({ type: C.INIT }), (h = { dispatch: We, subscribe: Pe, getState: Ee, replaceReducer: Ae })[y] = Ke, h;
        }
        ...
        function z() {
          ...
          return { clear: function() {
            ...
            var _ = !0, T = d = { callback: h, next: null, prev: d };
            return T.prev ? T.prev.next = T : s = T, function() {
              _ && s !== null && (_ = !1, T.next ? T.next.prev = T.prev : d = T.prev, T.prev ? T.prev.next = T.next : s = T.next);
            };
          } };
        }
        ...
        function N(E, s) {
          ...
          function T() {
            d || (d = s ? s.addNestedSub(_) : E.subscribe(_), h = z());
          }
        ...
        var M = typeof window < "u" && window.document !== void 0 && window.document.createElement !== void 0 ? c.useLayoutEffect : c.useEffect, W = function(E) {
          var s = E.store, d = E.context, h = E.children, _ = Object(c.useMemo)(function() {
            var ne = N(s);
            return { store: s, subscription: ne };
          }, [s]), T = Object(c.useMemo)(function() {
            return s.getState();
          }, [s]);
          M(function() {
            var ne = _.subscription;
            return ne.onStateChange = ne.notifyNestedSubs, ne.trySubscribe(), T !== s.getState() && ne.notifyNestedSubs(), function() {
              ne.tryUnsubscribe(), ne.onStateChange = null;
            };
          }, [_, T]);
          var L = d || G;
          return o.a.createElement(L.Provider, { value: _ }, h);
        };
        function R() {
        ...
        function oe(E, s) {
          if (E == null) return {};
          var d, h, _ = {}, T = Object.keys(E);
          for (h = 0; h < T.length; h++) d = T[h], s.indexOf(d) >= 0 || (_[d] = E[d]);
          return _;
        }
        ...
        function de(E, s, d, h, _, T, L) {
          E.current = h, s.current = _, d.current = !1, T.current && (T.current = null, L());
        }
        function D(E, s, d, h, _, T, L, ne, fe, pe) {
          if (E) {
            var Ee = !1, Pe = null, We = function() {
              if (!Ee) {
                ...
                Ke || (Pe = null), Ae === T.current ? L.current || fe() : (T.current = Ae, ne.current = Ae, L.current = !0, pe({ type: "STORE_UPDATED", payload: { error: Ke } }));
              }
            };
            return d.onStateChange = We, d.trySubscribe(), We(), function() {
        ...
        function be(E, s) {
          s === void 0 && (s = {});
          var d = s, h = d.getDisplayName, _ = h === void 0 ? function(Le) {
            return "ConnectAdvanced(" + Le + ")";
          } : h, T = d.methodName, L = T === void 0 ? "connectAdvanced" : T, ne = d.renderCountProp, fe = ne === void 0 ? void 0 : ne, pe = d.shouldHandleStateChanges, Ee = pe === void 0 || pe, Pe = d.storeKey, We = Pe === void 0 ? "store" : Pe, Ae = (d.withRef, d.forwardRef), Ke = Ae !== void 0 && Ae, Ie = d.context, Fe = Ie === void 0 ? G : Ie, et = oe(d, se), Ye = Fe;
          return function(Le) {
            var dt = Le.displayName || Le.name || "Component", Dt = _(dt), It = R({}, et, { getDisplayName: _, methodName: L, renderCountProp: fe, shouldHandleStateChanges: Ee, storeKey: We, displayName: Dt, wrappedComponentName: dt, WrappedComponent: Le }), jt = et.pure, _t = jt ? c.useMemo : function(lt) {
              return lt();
            };
            function zt(lt) {
              ...
              }, [lt]), Vn = Mn[0], zr = Mn[1], xt = Mn[2], io = Object(c.useMemo)(function() {
                return Vn && Vn.Consumer && Object(A.isContextConsumer)(o.a.createElement(Vn.Consumer, null)) ? Vn : Ye;
              }, [Vn, Ye]), In = Object(c.useContext)(io), $t = !!lt.store && !!lt.store.getState && !!lt.store.dispatch;
              In && In.store;
              ...
              J(de, [gr, zi, ii, xt, Zn, Io, Lr]), J(D, [Ee, dn, fn, Xn, gr, zi, ii, Io, Lr, mr], [dn, fn, Xn]);
        ...
        function we(E, s) {
          ...
          for (var _ = 0; _ < d.length; _++) if (!Object.prototype.hasOwnProperty.call(s, d[_]) || !Te(E[d[_]], s[d[_]])) return !1;
          return !0;
        }
        function Ne(E) {
          return function(s, d) {
        ...
        function ze(E, s) {
          return function(d, h) {
            h.displayName;
            var _ = function(T, L) {
              return _.dependsOnOwnProps ? _.mapToProps(T, L) : _.mapToProps(T);
            };
            return _.dependsOnOwnProps = !0, _.mapToProps = function(T, L) {
              _.mapToProps = E, _.dependsOnOwnProps = xe(E);
              var ne = _(T, L);
              return typeof ne == "function" && (_.mapToProps = ne, _.dependsOnOwnProps = xe(ne), ne = _(T, L)), ne;
            }, _;
          };
        }
        var Je = [function(E) {
          ...
          return E && typeof E == "object" ? Ne(function(s) {
            return function(d, h) {
              var _ = {}, T = function(ne) {
                var fe = d[ne];
                typeof fe == "function" && (_[ne] = function() {
        ...
        var me = [function(E) {
          return typeof E == "function" ? /* @__PURE__ */ function(s) {
            return function(d, h) {
              h.displayName;
              var _, T = h.pure, L = h.areMergedPropsEqual, ne = !1;
              return function(fe, pe, Ee) {
                var Pe = s(fe, pe, Ee);
                return ne ? T && L(Pe, _) || (_ = Pe) : (ne = !0, _ = Pe), _;
              };
            };
          }(E) : void 0;
        }, function(E) {
        ...
        function f(E, s, d, h) {
          return function(_, T) {
            return d(E(_, T), s(h, T), T);
          };
        }
        function w(E, s, d, h, _) {
          var T, L, ne, fe, pe, Ee = _.areStatesEqual, Pe = _.areOwnPropsEqual, We = _.areStatePropsEqual, Ae = !1;
          function Ke(Ie, Fe) {
            var et, Ye, Le = !Pe(Fe, L), dt = !Ee(Ie, T);
            return T = Ie, L = Fe, Le && dt ? (ne = E(T, L), s.dependsOnOwnProps && (fe = s(h, L)), pe = d(ne, fe, L)) : Le ? (E.dependsOnOwnProps && (ne = E(T, L)), s.dependsOnOwnProps && (fe = s(h, L)), pe = d(ne, fe, L)) : (dt && (et = E(T, L), Ye = !We(et, ne), ne = et, Ye && (pe = d(ne, fe, L))), pe);
          }
          return function(Ie, Fe) {
            return Ae ? Ke(Ie, Fe) : (ne = E(T = Ie, L = Fe), fe = s(h, L), pe = d(ne, fe, L), Ae = !0, pe);
          };
        }
        function U(E, s) {
          var d = s.initMapStateToProps, h = s.initMapDispatchToProps, _ = s.initMergeProps, T = oe(s, l), L = d(E, T), ne = h(E, T), fe = _(E, T);
          return (T.pure ? w : f)(L, ne, fe, E, T);
        }
        ...
        function je(E) {
          var s = {}, d = s.connectHOC, h = d === void 0 ? be : d, _ = s.mapStateToPropsFactories, T = _ === void 0 ? X : _, L = s.mapDispatchToPropsFactories, ne = L === void 0 ? Je : L, fe = s.mergePropsFactories, pe = fe === void 0 ? me : fe, Ee = s.selectorFactory, Pe = Ee === void 0 ? U : Ee;
          return function(We, Ae, Ke, Ie) {
            Ie === void 0 && (Ie = {});
            var Fe = Ie, et = Fe.pure, Ye = et === void 0 || et, Le = Fe.areStatesEqual, dt = Le === void 0 ? he : Le, Dt = Fe.areOwnPropsEqual, It = Dt === void 0 ? we : Dt, jt = Fe.areStatePropsEqual, _t = jt === void 0 ? we : jt, zt = Fe.areMergedPropsEqual, ft = zt === void 0 ? we : zt, An = oe(Fe, F), lt = H(We, T, "mapStateToProps"), Mn = H(Ae, ne, "mapDispatchToProps"), Vn = H(Ke, pe, "mergeProps");
            return h(Pe, R({ methodName: "connect", getDisplayName: function(zr) {
              return "Connect(" + zr + ")";
            }, shouldHandleStateChanges: !!We, initMapStateToProps: lt, initMapDispatchToProps: Mn, initMergeProps: Vn, pure: Ye, areStatesEqual: dt, areOwnPropsEqual: It, areStatePropsEqual: _t, areMergedPropsEqual: ft }, An));
          };
        }
        var Re = je(), Xe;
        Xe = S.unstable_batchedUpdates, K = Xe;
        function Ve(E) {
          ...
          const h = function(_, T, L) {
            ...
            switch (L.type) {
              ...
              case "SET_MODEL_CURRENT_NODE":
                return { ...T, currentNode: L.currentNode, currentNodeDefinition: Object(gt.b)(Tt(_), L.currentNode) };
        ...
        function or(E, s, d) {
          const h = Tt(E), _ = { ...s, ...d }, T = _.currentRootName, L = Object(gt.c)(h, T), ne = Object(gt.a)(h, T), fe = Object(gt.e)({ currentEditor: h, currentRootName: _.currentRootName, ranges: L, markers: ne });
          let pe = _.currentNode, Ee = _.currentNodeDefinition;
          return pe ? pe.root.rootName !== T || !Object(cn.d)(pe) && !pe.parent ? (pe = null, Ee = null) : Ee = Object(gt.b)(h, pe) : Ee = null, { treeDefinition: fe, currentNode: pe, currentNodeDefinition: Ee, ranges: L, markers: ne };
        }
        function _r(E) {
          ...
          const h = function(_, T, L) {
            ...
            switch (L.type) {
              ...
              case "SET_VIEW_CURRENT_NODE":
                return { ...T, currentNode: L.currentNode, currentNodeDefinition: Object(en.b)(L.currentNode) };
              case "SET_ACTIVE_INSPECTOR_TAB":
        ...
        function qt(E, s = {}) {
          const d = Tt(E), h = Object(en.d)(d), _ = h[0] ? h[0].rootName : null;
          return { ...s, ...gn(E, s, { currentRootName: _ }), currentRootName: _, currentNode: null, currentNodeDefinition: null };
        }
        function gn(E, s, d) {
          const h = { ...s, ...d }, _ = h.currentRootName, T = Object(en.c)(Tt(E), _), L = Object(en.e)({ currentEditor: Tt(E), currentRootName: _, ranges: T });
          let ne = h.currentNode, fe = h.currentNodeDefinition;
          return ne ? ne.root.rootName !== _ || !Object(Yt.g)(ne) && !ne.parent ? (ne = null, fe = null) : fe = Object(en.b)(ne) : fe = null, { treeDefinition: L, currentNode: ne, currentNodeDefinition: fe, ranges: T };
        }
        function Sr() {
        ...
        function bn({ editors: E, currentEditorName: s }) {
          ...
          for (const [h, _] of E.get(s).commands) {
            const T = [];
            _.value !== void 0 && T.push(["value", Object(ut.a)(_.value, !1)]), d.push({ name: h, type: "element", children: [], node: h, attributes: T, presentation: { isEmpty: !0, cssClass: ["ck-inspector-tree-node_tagless", _.isEnabled ? "" : "ck-inspector-tree-node_disabled"].join(" ") } });
          }
          return d.sort((h, _) => h.name > _.name ? 1 : -1);
        }
        function Tr(E, s = {}) {
        ...
        function sr({ editors: E, currentEditorName: s }, d) {
          if (!d) return null;
          const h = E.get(s).model.schema, _ = h.getDefinitions()[d], T = {}, L = {}, ne = {};
          let fe = {};
          for (const pe of ar) _[pe] && (T[pe] = { value: _[pe] });
          for (const pe of _.allowChildren.sort()) L[pe] = { value: !0, title: "Click to see the definition of " + pe };
          for (const pe of _.allowIn.sort()) ne[pe] = { value: !0, title: "Click to see the definition of " + pe };
          for (const pe of _.allowAttributes.sort()) fe[pe] = { value: !0 };
          fe = Object(ut.b)(fe);
          for (const pe in fe) {
        ...
        var On = u(8);
        function Gr(E, s) {
          const d = function(h, _) {
            switch (_.type) {
              case "SET_EDITORS":
                return function(T, L) {
                  const ne = { editors: new Map(L.editors) };
                  return L.editors.size ? L.editors.has(T.currentEditorName) || (ne.currentEditorName = Object(On.b)(L.editors)) : ne.currentEditorName = null, { ...T, ...ne };
                }(h, _);
              case "SET_CURRENT_EDITOR_NAME":
                return function(T, L) {
                  return { ...T, currentEditorName: L.editorName };
                }(h, _);
              default:
                return h;
            }
          }(E, s);
          return d.currentEditorGlobals = function(h, _, T) {
            switch (T.type) {
              case "SET_EDITORS":
              case "SET_CURRENT_EDITOR_NAME":
                return { ...Xr(h, {}) };
          ...
          }(d, d.currentEditorGlobals, s), d.ui = function(h, _) {
            if (!h.activeTab) {
              let T;
            ...
            switch (_.type) {
              case "TOGGLE_IS_COLLAPSED":
                return function(T) {
                  const L = !T.isCollapsed;
                  return pt.set("is-collapsed", L), { ...T, isCollapsed: L };
                }(h);
              case "SET_HEIGHT":
                return function(T, L) {
                  return pt.set("height", L.newHeight), { ...T, height: L.newHeight };
                }(h, _);
              case "SET_SIDE_PANE_WIDTH":
                return function(T, L) {
                  return pt.set("side-pane-width", L.newWidth), { ...T, sidePaneWidth: L.newWidth };
                }(h, _);
              case "SET_ACTIVE_INSPECTOR_TAB":
                return function(T, L) {
                  return pt.set("active-tab-name", L.tabName), { ...T, activeTab: L.tabName };
                }(h, _);
              default:
                return h;
            }
          }(d.ui, s), d.model = Yn(d, d.model, s), d.view = xr(d, d.view, s), d.commands = function(h, _, T) {
          ...
          }(d, d.commands, s), d.schema = function(h, _, T) {
        ...
        var V = u(46), ae = u.n(V), ke = /* @__PURE__ */ function() {
          var E = function(s, d) {
          ...
          return (Ce = Object.assign || function(E) {
            for (var s, d = 1, h = arguments.length; d < h; d++) for (var _ in s = arguments[d]) Object.prototype.hasOwnProperty.call(s, _) && (E[_] = s[_]);
            return E;
          }).apply(this, arguments);
          ...
          d === void 0 && (d = 0);
          var h = s.reduce(function(T, L, ne) {
            return Math.abs(L - E) < Math.abs(s[T] - E) ? ne : T;
          }, 0), _ = Math.abs(s[h] - E);
          return d === 0 || _ < d ? s[h] : E;
        }), ct = tt()(function(E, s) {
          ...
          return E;
        }, Pn = tt()(function(E, s, d, h, _, T, L) {
          return h = un(h, E.width, s, d), _ = un(_, E.height, s, d), T = un(T, E.width, s, d), L = un(L, E.height, s, d), { maxWidth: h === void 0 ? void 0 : Number(h), maxHeight: _ === void 0 ? void 0 : Number(_), minWidth: T === void 0 ? void 0 : Number(T), minHeight: L === void 0 ? void 0 : Number(L) };
          ...
          return Ot(s, E), Object.defineProperty(s.prototype, "parentNode", { get: function() {
            ...
            if (this.resizable && this.window) {
              var _ = this.resizable.offsetWidth, T = this.resizable.offsetHeight, L = this.resizable.style.position;
              L !== "relative" && (this.resizable.style.position = "relative"), d = this.resizable.style.width !== "auto" ? this.resizable.offsetWidth : _, h = this.resizable.style.height !== "auto" ? this.resizable.offsetHeight : T, this.resizable.style.position = L;
            }
            return { width: d, height: h };
          }, enumerable: !1, configurable: !0 }), Object.defineProperty(s.prototype, "sizeStyle", { get: function() {
            var d = this, h = this.props.size, _ = function(T) {
              if (d.state[T] === void 0 || d.state[T] === "auto") return "auto";
              if (d.propsSize && d.propsSize[T] && ct(d.propsSize[T].toString(), "%")) {
                if (ct(d.state[T].toString(), "%")) return d.state[T].toString();
                var L = d.getParentSize();
                return Number(d.state[T].toString().replace("px", "")) / L[T] * 100 + "%";
              }
              return yn(d.state[T]);
            };
            ...
            _ !== "wrap" && (h = !0, this.parentNode.style.flexWrap = "wrap"), d.style.position = "relative", d.style.minWidth = "100%";
            var T = { width: d.offsetWidth, height: d.offsetHeight };
            return h && (this.parentNode.style.flexWrap = _), this.removeBase(d), T;
            ...
            return this.state[h] !== "auto" || this.state.original[h] !== d || _ !== void 0 && _ !== "auto" ? d : "auto";
          }, s.prototype.calculateNewMaxFromBoundary = function(d, h) {
            var _, T, L = this.props.boundsByDirection, ne = this.state.direction, fe = L && ht("left", ne), pe = L && ht("top", ne);
            if (this.props.bounds === "parent") {
              var Ee = this.parentNode;
              Ee && (_ = fe ? this.resizableRight - this.parentLeft : Ee.offsetWidth + (this.parentLeft - this.resizableLeft), T = pe ? this.resizableBottom - this.parentTop : Ee.offsetHeight + (this.parentTop - this.resizableTop));
            } else this.props.bounds === "window" ? this.window && (_ = fe ? this.resizableRight : this.window.innerWidth - this.resizableLeft, T = pe ? this.resizableBottom : this.window.innerHeight - this.resizableTop) : this.props.bounds && (_ = fe ? this.resizableRight - this.targetLeft : this.props.bounds.offsetWidth + (this.targetLeft - this.resizableLeft), T = pe ? this.resizableBottom - this.targetTop : this.props.bounds.offsetHeight + (this.targetTop - this.resizableTop));
            return _ && Number.isFinite(_) && (d = d && d < _ ? d : _), T && Number.isFinite(T) && (h = h && h < T ? h : T), { maxWidth: d, maxHeight: h };
          }, s.prototype.calculateNewSizeFromDirection = function(d, h) {
            var _ = this.props.scale || 1, T = this.props.resizeRatio || 1, L = this.state, ne = L.direction, fe = L.original, pe = this.props, Ee = pe.lockAspectRatio, Pe = pe.lockAspectRatioExtraHeight, We = pe.lockAspectRatioExtraWidth, Ae = fe.width, Ke = fe.height, Ie = Pe || 0, Fe = We || 0;
            return ht("right", ne) && (Ae = fe.width + (d - fe.x) * T / _, Ee && (Ke = (Ae - Fe) / this.ratio + Ie)), ht("left", ne) && (Ae = fe.width - (d - fe.x) * T / _, Ee && (Ke = (Ae - Fe) / this.ratio + Ie)), ht("bottom", ne) && (Ke = fe.height + (h - fe.y) * T / _, Ee && (Ae = (Ke - Ie) * this.ratio + Fe)), ht("top", ne) && (Ke = fe.height - (h - fe.y) * T / _, Ee && (Ae = (Ke - Ie) * this.ratio + Fe)), { newWidth: Ae, newHeight: Ke };
          }, s.prototype.calculateNewSizeFromAspectRatio = function(d, h, _, T) {
            var L = this.props, ne = L.lockAspectRatio, fe = L.lockAspectRatioExtraHeight, pe = L.lockAspectRatioExtraWidth, Ee = T.width === void 0 ? 10 : T.width, Pe = _.width === void 0 || _.width < 0 ? d : _.width, We = T.height === void 0 ? 10 : T.height, Ae = _.height === void 0 || _.height < 0 ? h : _.height, Ke = fe || 0, Ie = pe || 0;
            if (ne) {
              var Fe = (We - Ke) * this.ratio + Ie, et = (Ae - Ke) * this.ratio + Ie, Ye = (Ee - Ie) / this.ratio + Ke, Le = (Pe - Ie) / this.ratio + Ke, dt = Math.max(Ee, Fe), Dt = Math.min(Pe, et), It = Math.max(We, Ye), jt = Math.min(Ae, Le);
              d = Nt(d, dt, Dt), h = Nt(h, It, jt);
            } else d = Nt(d, Ee, Pe), h = Nt(h, We, Ae);
            ...
            if (this.resizable) {
              var T = this.resizable.getBoundingClientRect(), L = T.left, ne = T.top, fe = T.right, pe = T.bottom;
            ...
            if (this.resizable && this.window) {
              ...
              if (d.nativeEvent && function(Pe) {
                ...
                if (T = d.nativeEvent.clientX, L = d.nativeEvent.clientY, d.nativeEvent.which === 3) return;
              } else d.nativeEvent && Wt(d.nativeEvent) && (T = d.nativeEvent.touches[0].clientX, L = d.nativeEvent.touches[0].clientY);
              ...
              var Ee = { original: { x: T, y: L, width: this.size.width, height: this.size.height }, isResizing: !0, backgroundStyle: nt(nt({}, this.state.backgroundStyle), { cursor: this.window.getComputedStyle(d.target).cursor || "auto" }), direction: h, flexBasis: _ };
              this.setState(Ee);
            }
          }, s.prototype.onMouseMove = function(d) {
            if (this.state.isResizing && this.resizable && this.window) {
              if (this.window.TouchEvent && Wt(d)) try {
                d.preventDefault(), d.stopPropagation();
              } catch {
              }
              var h = this.props, _ = h.maxWidth, T = h.maxHeight, L = h.minWidth, ne = h.minHeight, fe = Wt(d) ? d.touches[0].clientX : d.clientX, pe = Wt(d) ? d.touches[0].clientY : d.clientY, Ee = this.state, Pe = Ee.direction, We = Ee.original, Ae = Ee.width, Ke = Ee.height, Ie = this.getParentSize(), Fe = Pn(Ie, this.window.innerWidth, this.window.innerHeight, _, T, L, ne);
              _ = Fe.maxWidth, T = Fe.maxHeight, L = Fe.minWidth, ne = Fe.minHeight;
              var et = this.calculateNewSizeFromDirection(fe, pe), Ye = et.newHeight, Le = et.newWidth, dt = this.calculateNewMaxFromBoundary(_, T), Dt = this.calculateNewSizeFromAspectRatio(Le, Ye, { width: dt.maxWidth, height: dt.maxHeight }, { width: L, height: ne });
            ...
            var h = this.state, _ = h.isResizing, T = h.direction, L = h.original;
            if (_ && this.resizable) {
              var ne = { width: this.size.width - L.width, height: this.size.height - L.height };
              this.props.onResizeStop && this.props.onResizeStop(d, T, this.resizable, ne), this.props.size && this.setState(this.props.size), this.unbindEvents(), this.setState({ isResizing: !1, backgroundStyle: nt(nt({}, this.state.backgroundStyle), { cursor: "auto" }) });
            }
          }, s.prototype.updateSize = function(d) {
            this.setState({ width: d.width, height: d.height });
          }, s.prototype.renderResizer = function() {
            var d = this, h = this.props, _ = h.enable, T = h.handleStyles, L = h.handleClasses, ne = h.handleWrapperStyle, fe = h.handleWrapperClass, pe = h.handleComponent;
            if (!_) return null;
            var Ee = Object.keys(_).map(function(Pe) {
              return _[Pe] !== !1 ? c.createElement(qe, { key: Pe, direction: Pe, onResizeStart: d.onResizeStart, replaceStyles: T && T[Pe], className: L && L[Pe] }, pe && pe[Pe] ? pe[Pe] : null) : null;
            });
            ...
            return c.createElement(T, nt({ ref: this.ref, style: _, className: this.props.className }, h), this.state.isResizing && c.createElement("div", { style: this.state.backgroundStyle }), this.props.children, this.renderResizer());
          ...
          return (rt = Object.setPrototypeOf || { __proto__: [] } instanceof Array && function(d, h) {
            ...
            for (var _ in h) h.hasOwnProperty(_) && (d[_] = h[_]);
          })(E, s);
        }, Ue = function() {
          ...
          return function(d, h) {
            ...
            rt(d, h), d.prototype = h === null ? Object.create(h) : (_.prototype = h.prototype, new _());
          }(s, E), s.prototype.componentDidMount = function() {
            this.updateOffsetFromParent();
            var d = this.offsetFromParent, h = d.left, _ = d.top, T = this.getDraggablePosition(), L = T.x, ne = T.y;
            this.draggable.setState({ x: L - h, y: ne - _ }), this.forceUpdate();
            ...
            if (this.props.onDragStart && this.props.onDragStart(d, h), this.props.bounds) {
              var _, T = this.getParent(), L = this.props.scale;
              if (this.props.bounds === "parent") _ = T;
              else {
                if (this.props.bounds === "body") {
                  var ne = T.getBoundingClientRect(), fe = ne.left, pe = ne.top, Ee = document.body.getBoundingClientRect(), Pe = -(fe - T.offsetLeft * L - Ee.left) / L, We = -(pe - T.offsetTop * L - Ee.top) / L, Ae = (document.body.offsetWidth - this.resizable.size.width * L) / L + Pe, Ke = (document.body.offsetHeight - this.resizable.size.height * L) / L + We;
                  return this.setState({ bounds: { top: We, right: Ae, bottom: Ke, left: Pe } });
                }
                if (this.props.bounds === "window") {
                  if (!this.resizable) return;
                  var Ie = T.getBoundingClientRect(), Fe = Ie.left, et = Ie.top, Ye = -(Fe - T.offsetLeft * L) / L, Le = -(et - T.offsetTop * L) / L;
              ...
              if (_ instanceof HTMLElement && T instanceof HTMLElement) {
                var dt = _.getBoundingClientRect(), Dt = dt.left, It = dt.top, jt = T.getBoundingClientRect(), _t = (Dt - jt.left) / L, zt = It - jt.top;
                if (this.resizable) {
                  this.updateOffsetFromParent();
                  var ft = this.offsetFromParent;
                  this.setState({ bounds: { top: zt - ft.top, right: _t + (_.offsetWidth - this.resizable.size.width) - ft.left / L, bottom: zt + (_.offsetHeight - this.resizable.size.height) - ft.top, left: _t - ft.left / L } });
                }
              }
            }
            ...
            if (this.props.onDrag) {
              ...
              return this.props.onDrag(d, Ue(Ue({}, h), { x: h.x - _.left, y: h.y - _.top }));
            }
          }, s.prototype.onDragStop = function(d, h) {
            if (this.props.onDragStop) {
              var _ = this.offsetFromParent, T = _.left, L = _.top;
              return this.props.onDragStop(d, Ue(Ue({}, h), { x: h.x + T, y: h.y + L }));
            }
          }, s.prototype.onResizeStart = function(d, h, _) {
            d.stopPropagation(), this.resizing = !0;
            var T = this.props.scale, L = this.offsetFromParent, ne = this.getDraggablePosition();
            if (this.resizingPosition = { x: ne.x + L.left, y: ne.y + L.top }, this.setState({ original: ne }), this.props.bounds) {
              ...
              if (Ee instanceof Element && (pe instanceof HTMLElement || pe === window) && fe instanceof HTMLElement) {
                var Pe = this.getMaxSizesFromProps(), We = Pe.maxWidth, Ae = Pe.maxHeight, Ke = this.getParentSize();
                ...
                if (_t && this.resizable) {
                  var lt = (et - dt) / T + this.resizable.size.width;
                  this.setState({ maxWidth: lt > Number(We) ? We : lt });
                }
                (zt || this.props.lockAspectRatio && !_t) && (lt = It + (dt - et) / T, this.setState({ maxWidth: lt > Number(We) ? We : lt })), ft && this.resizable && (lt = (Ye - Dt) / T + this.resizable.size.height, this.setState({ maxHeight: lt > Number(Ae) ? Ae : lt })), (An || this.props.lockAspectRatio && !ft) && (lt = jt + (Dt - Ye) / T, this.setState({ maxHeight: lt > Number(Ae) ? Ae : lt }));
              }
            } else this.setState({ maxWidth: this.props.maxWidth, maxHeight: this.props.maxHeight });
            this.props.onResizeStart && this.props.onResizeStart(d, h, _);
          }, s.prototype.onResize = function(d, h, _, T) {
            var L = { x: this.state.original.x, y: this.state.original.y }, ne = -T.width, fe = -T.height;
            ...
            this.resizingPosition = { x: Ee, y: Pe }, this.props.onResize && this.props.onResize(d, h, _, T, { x: Ee, y: Pe });
          }, s.prototype.onResizeStop = function(d, h, _, T) {
            this.resizing = !1;
            var L = this.getMaxSizesFromProps(), ne = L.maxWidth, fe = L.maxHeight;
            this.setState({ maxWidth: ne, maxHeight: fe }), this.props.onResizeStop && this.props.onResizeStop(d, h, _, T, this.resizingPosition);
          }, s.prototype.updateSize = function(d) {
            ...
            var d = this.props.scale, h = this.getParent(), _ = this.getSelfElement();
            if (!h || _ === null) return { top: 0, left: 0 };
            var T = h.getBoundingClientRect(), L = T.left, ne = T.top, fe = _.getBoundingClientRect(), pe = this.getDraggablePosition();
            this.offsetFromParent = { left: fe.left - L - pe.x * d, top: fe.top - ne - pe.y * d };
          }, s.prototype.render = function() {
            var d = this.props, h = d.disableDragging, _ = d.style, T = d.dragHandleClassName, L = d.position, ne = d.onMouseDown, fe = d.onMouseUp, pe = d.dragAxis, Ee = d.dragGrid, Pe = d.bounds, We = d.enableUserSelectHack, Ae = d.cancel, Ke = d.children, Ie = (d.onResizeStart, d.onResize, d.onResizeStop, d.onDragStart, d.onDrag, d.onDragStop, d.resizeHandleStyles), Fe = d.resizeHandleClasses, et = d.resizeHandleComponent, Ye = d.enableResizing, Le = d.resizeGrid, dt = d.resizeHandleWrapperClass, Dt = d.resizeHandleWrapperStyle, It = d.scale, jt = d.allowAnyClick, _t = function($t, dn) {
              var Xn = {};
            ...
            delete _t.default;
            var ft, An = h || T ? { cursor: "auto" } : { cursor: "move" }, lt = Ue(Ue(Ue({}, Kt), An), _), Mn = this.offsetFromParent, Vn = Mn.left, zr = Mn.top;
            L && (ft = { x: L.x - Vn, y: L.y - zr });
            var xt, io = this.resizing ? void 0 : ft, In = this.resizing ? "both" : pe;
            return Object(c.createElement)(qn, { ref: this.refDraggable, handle: T ? "." + T : void 0, defaultPosition: zt, onMouseDown: ne, onMouseUp: fe, onStart: this.onDragStart, onDrag: this.onDrag, onStop: this.onDragStop, axis: In, disabled: h, grid: Ee, bounds: Pe ? this.state.bounds : void 0, position: io, enableUserSelectHack: We, cancel: Ae, scale: It, allowAnyClick: jt, nodeRef: this.resizableElement }, Object(c.createElement)(_o, Ue({}, _t, { ref: this.refResizable, defaultSize: zt, size: this.props.size, enable: typeof Ye == "boolean" ? (xt = Ye, { bottom: xt, bottomLeft: xt, bottomRight: xt, left: xt, right: xt, top: xt, topLeft: xt, topRight: xt }) : Ye, onResizeStart: this.onResizeStart, onResize: this.onResize, onResizeStop: this.onResizeStop, style: lt, minWidth: this.props.minWidth, minHeight: this.props.minHeight, maxWidth: this.resizing ? this.state.maxWidth : this.props.maxWidth, maxHeight: this.resizing ? this.state.maxHeight : this.props.maxHeight, grid: Le, handleWrapperClass: dt, handleWrapperStyle: Dt, lockAspectRatio: this.props.lockAspectRatio, lockAspectRatioExtraWidth: this.props.lockAspectRatioExtraWidth, lockAspectRatioExtraHeight: this.props.lockAspectRatioExtraHeight, handleStyles: Ie, handleClasses: Fe, handleComponent: et, scale: this.props.scale }), Ke));
        ...
        class Qt extends c.Component {
          ...
          render() {
            const s = Array.isArray(this.props.children) ? this.props.children : [this.props.children];
            return o.a.createElement(Ht, null, [this.props.contentBefore, o.a.createElement(Mt, { key: "navigation", definitions: s.map((d) => d.props.label), activeTab: this.props.activeTab, onClick: this.handleTabClick }), this.props.contentAfter], s.filter((d) => d.props.label === this.props.activeTab));
          }
        }
        ...
        u(68);
        class Vt extends c.PureComponent {
          render() {
        ...
        var Kn = Re(({ editors: E, currentEditorName: s, model: { treeDefinition: d, currentRootName: h, currentNode: _, ui: { showMarkers: T, showCompactText: L } } }) => ({ treeDefinition: d, editors: E, currentEditorName: s, currentRootName: h, currentNode: _, showMarkers: T, showCompactText: L }), { toggleModelShowCompactText: function() {
        ...
        class fr extends c.Component {
          render() {
            ...
            for (const h in this.props.itemDefinitions) {
              const _ = this.props.itemDefinitions[h], { subProperties: T, presentation: L = {} } = _, ne = T && Object.keys(T).length, fe = Object(ut.c)(String(_.value), 2e3), pe = [o.a.createElement(Zr, { key: `${this.props.name}-${h}-name`, name: h, listUid: this.props.name, canCollapse: ne, colorBox: L.colorBox, expandCollapsibles: s, onClick: this.props.onPropertyTitleClick, title: _.title }), o.a.createElement("dd", { key: `${this.props.name}-${h}-value` }, o.a.createElement("input", { id: `${this.props.name}-${h}-value-input`, type: "text", value: fe, readOnly: !0 }))];
              ne && pe.push(o.a.createElement(fr, { name: `${this.props.name}-${h}`, key: `${this.props.name}-${h}`, itemDefinitions: T, presentation: this.props.presentation })), d.push(pe);
            }
        ...
        var wi = Re(({ editors: E, currentEditorName: s, model: { ranges: d } }) => {
          const h = E.get(s);
          return { editor: h, currentEditorName: s, info: function(_, T) {
            const L = _.model.document.selection, ne = L.anchor, fe = L.focus, pe = { properties: { isCollapsed: { value: L.isCollapsed }, isBackward: { value: L.isBackward }, isGravityOverridden: { value: L.isGravityOverridden }, rangeCount: { value: L.rangeCount } }, attributes: {}, anchor: Rr(Object(cn.a)(ne)), focus: Rr(Object(cn.a)(fe)), ranges: {} };
        ...
        function Rr({ path: E, stickiness: s, index: d, isAtEnd: h, isAtStart: _, offset: T, textNode: L }) {
          return { path: { value: E }, stickiness: { value: s }, index: { value: d }, isAtEnd: { value: h }, isAtStart: { value: _ }, offset: { value: T }, textNode: { value: L } };
        }
        class Ca extends c.Component {
          render() {
            const s = function(_) {
              ...
              return T;
            }(this.props.markers), d = function _(T) {
              const L = {};
              for (const ne in T) {
                const fe = T[ne];
                if (fe.name) {
                  ...
                  L[ne] = { value: pe + " marker" + (pe > 1 ? "s" : ""), subProperties: _(fe) };
                }
              }
              return L;
        ...
        var Yo = Re(({ editors: E, currentEditorName: s, model: { markers: d } }) => ({ editors: E, currentEditorName: s, markers: d }), {})(Ca);
        function Ei({ name: E, start: s, end: d, affectsData: h, managedUsingOperations: _ }) {
          return { name: { value: E }, start: { value: s.path }, end: { value: d.path }, affectsData: { value: h }, managedUsingOperations: { value: _ } };
        }
        u(74);
        ...
        var Ta = Re(({ currentEditorName: E, model: { ui: { activeTab: s } } }) => ({ currentEditorName: E, activeTab: s }), { setModelActiveTab: Ve })(qo);
        ...
        var Co = Re(({ editors: E, currentEditorName: s, view: { treeDefinition: d, currentRootName: h, currentNode: _, ui: { showElementTypes: T } } }) => ({ treeDefinition: d, editors: E, currentEditorName: s, currentRootName: h, currentNode: _, showElementTypes: T }), { setViewCurrentRootName: function(E) {
        ...
        var To = Re(({ editors: E, currentEditorName: s, view: { ranges: d } }) => {
          const h = E.get(s);
          return { editor: h, currentEditorName: s, info: function(_, T) {
            const L = _.editing.view.document.selection, ne = { properties: { isCollapsed: { value: L.isCollapsed }, isBackward: { value: L.isBackward }, isFake: { value: L.isFake }, rangeCount: { value: L.rangeCount } }, anchor: Ar(Object(Yt.a)(L.anchor)), focus: Ar(Object(Yt.a)(L.focus)), ranges: {} };
            T.forEach((fe, pe) => {
        ...
        var Ci = Re(({ editors: E, currentEditorName: s, commands: { currentCommandName: d, currentCommandDefinition: h } }) => ({ editors: E, currentEditorName: s, currentCommandName: d, currentCommandDefinition: h }), {})(Qo);
        class Hn extends c.Component {
          render() {
            return this.props.currentEditorName ? o.a.createElement(Et, { splitVertically: "true" }, o.a.createElement(xi, null), o.a.createElement(vn, null, o.a.createElement(Qt, { activeTab: "Inspect" }, o.a.createElement(Ci, { label: "Inspect" })))) : o.a.createElement(Et, { isEmpty: "true" }, o.a.createElement("p", null, "Nothing to show. Attach another editor instance to start inspecting."));
          }
        }
        var Oo = Re(({ currentEditorName: E }) => ({ currentEditorName: E }), { updateCommandsState: Sr })(Hn);
        ...
        var ri = Re(({ editors: E, currentEditorName: s, ui: { isCollapsed: d, height: h, activeTab: _ } }) => ({ isCollapsed: d, height: h, editors: E, currentEditorName: s, activeTab: _ }), { toggleIsCollapsed: At, setHeight: function(E) {
        ...
        class $e {
          ...
          static attach(...s) {
            ...
            for (const T in h) {
              const L = h[T];
              Pt.a.group("%cAttached the inspector to a CKEditor 5 instance. To learn more, visit https://ckeditor.com/docs/ckeditor5.", "font-weight: bold;"), Pt.a.log(`Editor instance "${T}"`, L), Pt.a.groupEnd(), $e._editors.set(T, L), L.on("destroy", () => {
                $e.detach(T);
          ...
          static attachToAll(s) {
            ...
            for (const _ of d) {
              ...
              T && !$e._isAttachedTo(T) && h.push(...$e.attach(T, s));
            }
            return h;
          }
          static detach(s) {
          ...
          static _mount(s) {
            ...
            d.className = "ck-inspector-wrapper", document.body.appendChild(d), $e._editorListener = new Er({ onModelChange() {
              ...
              const T = $e._store.getState(), L = T.editors.get(T.currentEditorName);
              h !== L && (h && $e._editorListener.stopListening(h), L && $e._editorListener.startListening(L), h = L);
            }), $e._store.subscribe(() => {
              const T = $e._store, L = T.getState().ui.isCollapsed, ne = _ && !L;
              _ = L, ne && (T.dispatch({ type: "UPDATE_MODEL_STATE" }), T.dispatch({ type: "UPDATE_COMMANDS_STATE" }), T.dispatch({ type: "UPDATE_VIEW_STATE" }));
            }), m.a.render(o.a.createElement(W, { store: $e._store }, o.a.createElement(ri, null)), d);
          }
...
var vu = yu();
const ku = /* @__PURE__ */ bu(vu);
/**
 * @link https://craftcms.com/
 * @copyright Copyright (c) Pixel & Tonic, Inc.
 * @license GPL-3.0-or-later
 */
const wu = function(Se) {
  const I = Se.plugins.get(tc), b = $(Se.ui.view.element), a = $(Se.sourceElement), u = `ckeditor${Math.floor(Math.random() * 1e9)}`, c = [
    "keypress",
    "keyup",
    "change",
    "focus",
  ...
  I.on("change:isSourceEditingMode", () => {
    const o = b.find(
      ".ck-source-editing-area"
    );
    if (I.isSourceEditingMode) {
      let S = o.attr("data-value");
      o.on(c, () => {
        S !== (S = o.attr("data-value")) && a.val(S);
      });
    } else
      o.off(`.${u}`);
  });
  ...
  a.on("clipboardOutput", (c, o) => {
    ...
    if (S && S.includes("<craft-entry") && !(o.method == "drop" && b === Se.id)) {
      if (o.method == "paste" || o.method == "drop" && b !== Se.id) {
        let m = S, g = !1;
        const y = Craft.siteId;
        let v = null, C = null;
        const O = Se.getData(), P = [...S.matchAll(/data-entry-id="([0-9]+)/g)];
        c.stop();
        const G = $(Se.ui.view.element);
        let z = G.parents("form").data("elementEditor");
        await z.ensureIsDraftOrRevision(), v = z.settings.elementId, C = G.parents(".field").data("layoutElement");
        for (let B = 0; B < P.length; B++) {
          ...
          if (P[B][1] && (N = P[B][1]), N !== null) {
            ...
            if (!(b === Se.id && !M.test(O))) {
              let W = null;
              b !== Se.id && (I.includes(fu) ? W = Se.config.get("entryTypeOptions").map((R) => R.value) : (Craft.cp.displayError(
                Craft.t(
                  "ckeditor",
...
}, Nu = async function(Se, I) {
  typeof Se == "string" && (Se = document.querySelector(`#${Se}`)), I.licenseKey = "GPL";
  const b = await eu.create(Se, I);
  return Craft.showCkeditorInspector && Craft.userIsAdmin && ku.attach(b), b.editing.view.change((a) => {
    const u = b.editing.view.document.getRoot();
    if (typeof I.accessibleFieldName < "u" && I.accessibleFieldName.length) {
      let c = u.getAttribute("aria-label");
      a.setAttribute(
        "aria-label",
        I.accessibleFieldName + ", " + c,
        u
      );
    }
    typeof I.describedBy < "u" && I.describedBy.length && a.setAttribute(
      "aria-describedby",
      I.describedBy,
      u
    );
  ...
  }), I.plugins.includes(tc) && wu(b), I.plugins.includes(tu) && Eu(b, I), _u(b, I.plugins), b;
};
export {
  fu as CraftEntries,
  Su as CraftImageInsertUI,
  Ou as CraftLink,
  Tu as ImageEditor,
  Cu as ImageTransform,
  Nu as create
};
